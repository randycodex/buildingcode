...
Inventory revision 5: September 9, 2026. Latest three-case live comparison runtime: `0d6d9918e358943cfba657c8abd1fee7cfa46514` (source-resolution prompt v13). All three drafts stopped on its exact-copy format requirement before semantic verification. Prompt v14 replaces that duplicated wording with references rendered before verification; it has local tests only. The full cohort has not been rerun on one current baseline.
...
2. The two wording comparisons and v13 structure comparison are complete. V14 replaces the failed exact-copy requirement with explicit rendered references and has passed local checks. Next obtain a new committed-source preflight and capped comparison within the remaining allowance. Preserve complete sources, the review-type permission as an acceptance requirement, verifier materiality review and all other repair groups. Do not solve the fee detour by expanding the reference into an exhaustive filing manual or overriding failed results.
...
The latest source-resolution comparison made **three paid draft calls across three HTTP Research turns** and zero verifier calls. There was no paid search, retry or separate judge. Its conservative charge is **$0.120439** and usage estimate is $0.06581900. The unchanged aggregate authorization is $8.50; retained conservative spending is **$8.214661**, leaving **$0.285339**. Recorded usage estimates total $4.34487117. These are ledger figures; the API account balance and invoice were not checked. The older historical campaign remains separate. Inventory generation, manual review and the v14 local repair made zero provider or network calls. Consumed live drivers must not be replayed.
...
| DOBNOW-003 | Subsequent plumbing filing | No delivered answer in latest attempt | R1, R2, R7 | [result](../evals/results/research-owner-api-round2-live-source-resolutions-2026-09-09.json) · [review](../evals/results/research-owner-source-resolutions-answer-assessment-2026-09-09.json) |
...
| DOBNOW-023 | Filing representative attestation boundary | No delivered answer in latest attempt | R5, R7 | [result](../evals/results/research-owner-api-round2-live-source-resolutions-2026-09-09.json) · [review](../evals/results/research-owner-source-resolutions-answer-assessment-2026-09-09.json) |
