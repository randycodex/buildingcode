...
Inventory revision 6: September 9, 2026. Latest two-case live comparison runtime: `d81a7c73195ee814cb0af0967d2cba58c4af04f5` (source-resolution prompt v14). Both drafts used explicit references successfully and reached semantic verification. DOBNOW-023 was delivered; DOBNOW-003 was rejected for its timing explanation. Neither is a complete reference pass. The full cohort has not been rerun on one current baseline.
...
Affected questions: ZR-04, ZR-09, ZR-13, ZR-16, DOBNOW-002, DOBNOW-003, DOBNOW-013, DOBNOW-015, DOBNOW-016, DOBNOW-020, DOBNOW-021, DOBNOW-024, MC-04, MC-10, DOBNOW-023.
...
2. The v14 comparison confirms reference rendering in both live samples; further format-only retries are not justified. Repair the subsequent route's missing release-history evidence, preserve the unresolved timing question, and retain the representative's permitted-preparation distinction in the actor answer. Review the verifier's inaccurate claim that the omitted data-entry point was present. Preserve complete source contexts, different-review-type permission and all other repair groups. Do not solve the fee detour by expanding the reference into an exhaustive filing manual or overriding failed results.
...
The latest reference-rendering comparison made **four paid calls across two HTTP Research turns**: two drafts and two independent verifiers. There was no paid search, retry or separate judge. Its conservative charge is **$0.089756** and usage estimate is $0.04862810. The unchanged aggregate authorization is $8.50; retained conservative spending is **$8.304417**, leaving **$0.195583**. Recorded usage estimates total $4.39349927. These are ledger figures; the API account balance and invoice were not checked. The older historical campaign remains separate. Manual review and inventory generation made zero provider or network calls. Consumed live drivers must not be replayed.
...
| DOBNOW-023 | Filing representative attestation boundary | Delivered; substance or scope gap | R2, R5, R7 | [result](../evals/results/research-owner-api-round2-live-source-resolution-parts-2026-09-09.json) · [review](../evals/results/research-owner-source-resolution-parts-answer-assessment-2026-09-09.json) |
