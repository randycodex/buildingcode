const shellCacheName = "permitext-pro-shell-v301";
...
const shellURLs = [
  ...
  "/web/styles.css?v=20260801-project-controls-gap-v336",
  "/web/workboard-assets/workboard.css?v=20260801-project-header-alignment-v64",
  "/web/app.js?v=20260801-project-controls-gap-v336",
  "/web/client-reliability.js?v=20260731-debug-audit-v1",
  "/web/offline-storage.js?v=20260801-project-controls-gap-v336",
