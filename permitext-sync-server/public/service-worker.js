const shellCacheName = "permitext-pro-shell-v314";
...
const shellURLs = [
  ...
  "/web/styles.css?v=20260801-project-card-gap-v348",
  "/web/workboard-assets/workboard.css?v=20260801-workboard-canvas-v66",
  "/web/app.js?v=20260801-project-card-gap-v348",
  "/web/client-reliability.js?v=20260731-debug-audit-v1",
  "/web/offline-storage.js?v=20260801-project-card-gap-v348",
