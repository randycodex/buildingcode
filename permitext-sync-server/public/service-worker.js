const shellCacheName = "permitext-pro-shell-v317";
...
const shellURLs = [
  ...
  "/web/styles.css?v=20260801-notebook-text-size-v351",
  "/web/workboard-assets/workboard.css?v=20260801-workboard-canvas-v66",
  "/web/app.js?v=20260801-notebook-text-size-v351",
  "/web/client-reliability.js?v=20260731-debug-audit-v1",
  "/web/offline-storage.js?v=20260801-notebook-text-size-v351",
