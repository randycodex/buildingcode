const shellCacheName = "permitext-pro-shell-v829";
...
const shellURLs = [
  ...
  "/web/offline-storage.js?v=20260912-note-weight-v90",
  "/web/research-intent-state.js?v=20260912-note-weight-v90",
