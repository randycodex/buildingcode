const shellCacheName = "permitext-pro-shell-v320";
...
const shellURLs = [
  ...
  "/web/styles.css?v=20260801-folder-band-match-v354",
  "/web/workboard-assets/workboard.css?v=20260801-folder-band-match-v67",
  "/web/app.js?v=20260801-folder-band-match-v354",
  "/web/client-reliability.js?v=20260731-debug-audit-v1",
  "/web/offline-storage.js?v=20260801-folder-band-match-v354",
