const shellCacheName = "permitext-pro-shell-v854";
...
const shellURLs = [
  ...
  "/web/styles.css?v=20260912-report-owned-note-add-v115",
  "/web/fonts/source-serif-4-latin-wght-normal.woff2",
  "/web/fonts/source-serif-4-latin-wght-italic.woff2",
  "/web/app.js?v=20260912-report-owned-note-add-v115",
  ...
  "/web/offline-storage.js?v=20260912-report-owned-note-add-v115",
  "/web/research-intent-state.js?v=20260912-report-owned-note-add-v115",
