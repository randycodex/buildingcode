const shellCacheName = "permitext-pro-shell-v505";
...
const shellURLs = [
  ...
  "/web/app.js?v=20260809-project-research-entry-v3",
  "/web/client-reliability.js?v=20260809-session-stability-v1",
  "/web/offline-storage.js?v=20260809-project-research-entry-v3",
