const shellCacheName = "permitext-pro-shell-v818";
...
const shellURLs = [
  ...
  "/web/offline-storage.js?v=20260912-account-copy-v79",
  "/web/research-intent-state.js?v=20260912-account-copy-v79",
