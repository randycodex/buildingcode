import { definitionBundleID, definitionsForReader } from './reader-definition-registry.js?v=20260915-definitions-v28';
import { installDefinitionLinks } from './reader-definition-popover.js?v=20260915-definitions-v28';

const contexts=new WeakMap();
let registryPromise;
function loadRegistry() {
  if(!registryPromise)registryPromise=fetch('/web/reader-definition-registry.json?v=20260915-definitions-v28')
