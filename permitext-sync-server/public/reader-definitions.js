import { definitionAppliesToSection } from './definition-matcher.js?v=20260916-definitions-v53';
import { definitionBundleID, definitionsForReader } from './reader-definition-registry.js?v=20260916-definitions-v53';
import { installDefinitionLinks } from './reader-definition-popover.js?v=20260916-definitions-v53';

const contexts=new WeakMap();
let registryPromise;
function loadRegistry() {
  if(!registryPromise)registryPromise=fetch('/web/reader-definition-registry.json?v=20260916-definitions-v53')
