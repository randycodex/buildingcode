...
const shellCacheName = "permitext-pro-shell-v115";
const shellAssetVersion = "20260728-reader-clean-header-v117";
...
const shellURLs = [
  ...
  "/web/styles.css?v=20260728-reader-clean-header-v103",
  "/web/workboard-assets/workboard.css?v=20260722-workboard-zoom-v57",
  "/web/app.js?v=20260728-reader-clean-header-v117",
  "/web/offline-storage.js?v=20260728-reader-clean-header-v117",
