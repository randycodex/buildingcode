...
const shellCacheName = "permitext-pro-shell-v243";
const shellAssetVersion = "20260731-project-derived-colors-v278";
...
const shellURLs = [
  ...
  "/web/styles.css?v=20260731-project-derived-colors-v278",
  "/web/app.js?v=20260731-project-derived-colors-v278",
  "/web/client-reliability.js?v=20260731-debug-audit-v1",
  "/web/offline-storage.js?v=20260731-project-derived-colors-v278",
