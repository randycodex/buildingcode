...
const shellCacheName = "permitext-pro-shell-v573";
const shellAssetVersion = "20260811-research-code-basis-v2";
...
const shellURLs = [
  ...
  "/web/styles.css?v=20260811-research-code-basis-v2",
  ...
  "/web/app.js?v=20260811-research-code-basis-v2",
  "/web/client-reliability.js?v=20260809-session-stability-v1",
  "/web/offline-storage.js?v=20260811-research-code-basis-v2",
  "/web/sync-conflict-resolution.js?v=20260809-code-decision-v5",
  "/web/workspace-state.js?v=20260811-research-code-basis-v2",
