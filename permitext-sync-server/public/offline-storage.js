...
const shellCacheName = "permitext-pro-shell-v227";
const shellAssetVersion = "20260731-hide-empty-layout-v262";
...
const shellURLs = [
  ...
  "/web/styles.css?v=20260731-hide-empty-layout-v262",
  "/web/app.js?v=20260731-hide-empty-layout-v262",
  "/web/client-reliability.js?v=20260731-debug-audit-v1",
  "/web/offline-storage.js?v=20260731-hide-empty-layout-v262",
