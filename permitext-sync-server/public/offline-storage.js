...
const shellCacheName = "permitext-pro-shell-v245";
const shellAssetVersion = "20260731-edge-resize-v280";
...
const shellURLs = [
  ...
  "/web/styles.css?v=20260731-edge-resize-v280",
  "/web/app.js?v=20260731-edge-resize-v280",
  "/web/client-reliability.js?v=20260731-debug-audit-v1",
  "/web/offline-storage.js?v=20260731-edge-resize-v280",
