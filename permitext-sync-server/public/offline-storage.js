...
const shellCacheName = "permitext-pro-shell-v482";
const shellAssetVersion = "20260809-session-stability-v4";
...
const shellURLs = [
  ...
  "/web/styles.css?v=20260809-panel-divider-v1",
  ...
  "/web/app.js?v=20260809-session-stability-v4",
  "/web/client-reliability.js?v=20260809-session-stability-v1",
  "/web/offline-storage.js?v=20260809-session-stability-v4",
