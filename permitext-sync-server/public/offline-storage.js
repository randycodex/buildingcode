...
const shellCacheName = "permitext-pro-shell-v422";
const shellAssetVersion = "20260802-project-state-flicker-v458";
...
const shellURLs = [
  ...
  "/web/styles.css?v=20260802-research-folder-groups-v457",
  "/web/app.js?v=20260802-project-state-flicker-v458",
  "/web/client-reliability.js?v=20260731-debug-audit-v1",
  "/web/offline-storage.js?v=20260802-project-state-flicker-v458",
  "/web/workspace-state.js?v=20260802-project-state-flicker-v3",
