...
const shellCacheName = "permitext-pro-shell-v483";
const shellAssetVersion = "20260809-session-stability-v5";
...
const shellURLs = [
  ...
  "/web/styles.css?v=20260809-panel-divider-v2",
  ...
  "/web/app.js?v=20260809-session-stability-v5",
  "/web/client-reliability.js?v=20260809-session-stability-v1",
  "/web/offline-storage.js?v=20260809-session-stability-v5",
