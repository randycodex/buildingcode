...
const shellCacheName = "permitext-pro-shell-v513";
const shellAssetVersion = "20260809-candidate-format-v2";
...
const shellURLs = [
  ...
  "/web/styles.css?v=20260809-candidate-format-v2",
  ...
  "/web/app.js?v=20260809-question-selector-v1",
  "/web/client-reliability.js?v=20260809-session-stability-v1",
  "/web/offline-storage.js?v=20260809-candidate-format-v2",
