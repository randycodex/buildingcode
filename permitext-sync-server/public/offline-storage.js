...
const shellCacheName = "permitext-pro-shell-v239";
const shellAssetVersion = "20260731-collapsed-activity-v274";
...
const shellURLs = [
  ...
  "/web/styles.css?v=20260731-collapsed-activity-v274",
  "/web/app.js?v=20260731-collapsed-activity-v274",
  "/web/client-reliability.js?v=20260731-debug-audit-v1",
  "/web/offline-storage.js?v=20260731-collapsed-activity-v274",
