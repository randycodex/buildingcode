...
const shellCacheName = "permitext-pro-shell-v393";
const shellAssetVersion = "20260802-saved-row-status-v429";
...
const shellURLs = [
  ...
  "/web/styles.css?v=20260802-saved-row-status-v429",
  "/web/app.js?v=20260802-saved-row-status-v429",
  "/web/client-reliability.js?v=20260731-debug-audit-v1",
  "/web/offline-storage.js?v=20260802-saved-row-status-v429",
