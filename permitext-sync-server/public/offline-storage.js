...
const shellCacheName = "permitext-pro-shell-v546";
const shellAssetVersion = "20260809-project-tile-label-v1";
...
const shellURLs = [
  ...
  "/web/styles.css?v=20260809-project-tile-label-v1",
  ...
  "/web/app.js?v=20260809-project-tile-label-v1",
  "/web/client-reliability.js?v=20260809-session-stability-v1",
  "/web/offline-storage.js?v=20260809-project-tile-label-v1",
  "/web/sync-conflict-resolution.js?v=20260809-code-decision-v5",
  "/web/workspace-state.js?v=20260809-project-tile-label-v1",
  ...
  "/web/sync-state.js?v=20260809-project-tile-label-v1"
];
