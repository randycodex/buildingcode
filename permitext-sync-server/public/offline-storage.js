...
const shellCacheName = "permitext-pro-shell-v725";
const shellAssetVersion = "20260823-reader-only-scrollbars-v2";
...
const shellURLs = [
  ...
  "/web/styles.css?v=20260823-reader-only-scrollbars-v2",
  "/web/fonts/source-serif-4-latin-wght-normal.woff2",
  "/web/fonts/source-serif-4-latin-wght-italic.woff2",
  "/web/app.js?v=20260823-reader-only-scrollbars-v2",
  ...
  "/web/offline-storage.js?v=20260823-reader-only-scrollbars-v2",
  "/web/research-intent-state.js?v=20260823-reader-only-scrollbars-v2",
