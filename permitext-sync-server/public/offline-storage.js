...
const shellCacheName = "permitext-pro-shell-v232";
const shellAssetVersion = "20260731-topbar-drag-v267";
...
const shellURLs = [
  ...
  "/web/styles.css?v=20260731-topbar-drag-v267",
  "/web/app.js?v=20260731-topbar-drag-v267",
  "/web/client-reliability.js?v=20260731-debug-audit-v1",
  "/web/offline-storage.js?v=20260731-topbar-drag-v267",
