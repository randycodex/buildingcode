...
const shellCacheName = "permitext-pro-shell-v246";
const shellAssetVersion = "20260731-project-x-overflow-v281";
...
const shellURLs = [
  ...
  "/web/styles.css?v=20260731-project-x-overflow-v281",
  "/web/app.js?v=20260731-project-x-overflow-v281",
  "/web/client-reliability.js?v=20260731-debug-audit-v1",
  "/web/offline-storage.js?v=20260731-project-x-overflow-v281",
