...
const shellCacheName = "permitext-pro-shell-v780";
const shellAssetVersion = "20260905-account-verification-env-v41";
...
const shellURLs = [
  ...
  "/web/styles.css?v=20260905-account-verification-env-v41",
  "/web/fonts/source-serif-4-latin-wght-normal.woff2",
  "/web/fonts/source-serif-4-latin-wght-italic.woff2",
  "/web/app.js?v=20260905-account-verification-env-v41",
  ...
  "/web/offline-storage.js?v=20260905-account-verification-env-v41",
  "/web/research-intent-state.js?v=20260905-account-verification-env-v41",
