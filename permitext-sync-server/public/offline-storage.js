...
const shellCacheName = "permitext-pro-shell-v639";
const shellAssetVersion = "20260812-report-idle-status-v58";
...
const shellURLs = [
  ...
  "/web/styles.css?v=20260812-report-idle-status-v58",
  ...
  "/web/app.js?v=20260812-report-idle-status-v58",
  "/web/research-progress.js?v=20260812-report-idle-status-v58",
  "/web/client-reliability.js?v=20260809-session-stability-v1",
  "/web/offline-storage.js?v=20260812-report-idle-status-v58",
