...
const shellCacheName = "permitext-pro-shell-v252";
const shellAssetVersion = "20260731-blocknote-notebook-v287";
...
const shellURLs = [
  ...
  "/web/styles.css?v=20260731-blocknote-notebook-v287",
  "/web/app.js?v=20260731-blocknote-notebook-v287",
  "/web/client-reliability.js?v=20260731-debug-audit-v1",
  "/web/offline-storage.js?v=20260731-blocknote-notebook-v287",
