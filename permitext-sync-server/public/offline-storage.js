...
const shellCacheName = "permitext-pro-shell-v253";
const shellAssetVersion = "20260731-blocknote-notebook-v288";
...
const shellURLs = [
  ...
  "/web/styles.css?v=20260731-blocknote-notebook-v288",
  "/web/app.js?v=20260731-blocknote-notebook-v288",
  "/web/client-reliability.js?v=20260731-debug-audit-v1",
  "/web/offline-storage.js?v=20260731-blocknote-notebook-v288",
