...
const shellCacheName = "permitext-pro-shell-v644";
const shellAssetVersion = "20260812-report-delete-icon-v63";
...
const shellURLs = [
  ...
  "/web/styles.css?v=20260812-report-delete-icon-v63",
  ...
  "/web/app.js?v=20260812-report-delete-icon-v63",
  "/web/research-progress.js?v=20260812-report-delete-icon-v63",
  "/web/client-reliability.js?v=20260809-session-stability-v1",
  "/web/offline-storage.js?v=20260812-report-delete-icon-v63",
