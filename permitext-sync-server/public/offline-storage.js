...
const shellCacheName = "permitext-pro-shell-v471";
const shellAssetVersion = "20260808-project-column-no-activity-v1";
...
const shellURLs = [
  ...
  "/web/styles.css?v=20260808-project-column-no-activity-v1",
  ...
  "/web/app.js?v=20260808-project-column-no-activity-v1",
  "/web/client-reliability.js?v=20260731-debug-audit-v1",
  "/web/offline-storage.js?v=20260808-project-column-no-activity-v1",
  "/web/sync-conflict-resolution.js?v=20260808-project-column-no-activity-v1",
