...
const shellCacheName = "permitext-pro-shell-v354";
const shellAssetVersion = "20260802-clear-folder-links-v390";
...
const shellURLs = [
  ...
  "/web/styles.css?v=20260802-clear-folder-links-v390",
  "/web/app.js?v=20260802-clear-folder-links-v390",
  "/web/client-reliability.js?v=20260731-debug-audit-v1",
  "/web/offline-storage.js?v=20260802-clear-folder-links-v390",
