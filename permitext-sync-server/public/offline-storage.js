...
const shellCacheName = "permitext-pro-shell-v242";
const shellAssetVersion = "20260731-project-section-counts-v277";
...
const shellURLs = [
  ...
  "/web/styles.css?v=20260731-project-section-counts-v277",
  "/web/app.js?v=20260731-project-section-counts-v277",
  "/web/client-reliability.js?v=20260731-debug-audit-v1",
  "/web/offline-storage.js?v=20260731-project-section-counts-v277",
