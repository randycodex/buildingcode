...
const shellCacheName = "permitext-pro-shell-v225";
const shellAssetVersion = "20260731-multi-workspace-v260";
...
const shellURLs = [
  ...
  "/web/styles.css?v=20260731-multi-workspace-v260",
  "/web/app.js?v=20260731-multi-workspace-v260",
  "/web/client-reliability.js?v=20260731-debug-audit-v1",
  "/web/offline-storage.js?v=20260731-multi-workspace-v260",
