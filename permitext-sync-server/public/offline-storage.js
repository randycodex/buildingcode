...
const shellCacheName = "permitext-pro-shell-v515";
const shellAssetVersion = "20260809-candidate-queue-v1";
...
const shellURLs = [
  ...
  "/web/styles.css?v=20260809-candidate-queue-v1",
  ...
  "/web/app.js?v=20260809-candidate-queue-v1",
  "/web/client-reliability.js?v=20260809-session-stability-v1",
  "/web/offline-storage.js?v=20260809-candidate-queue-v1",
