...
const shellCacheName = "permitext-pro-shell-v739";
const shellAssetVersion = "20260824-property-context-v1";
...
const shellURLs = [
  ...
  "/web/styles.css?v=20260824-property-context-v1",
  "/web/fonts/source-serif-4-latin-wght-normal.woff2",
  "/web/fonts/source-serif-4-latin-wght-italic.woff2",
  "/web/app.js?v=20260824-property-context-v1",
  "/web/settings-copy.js?v=20260824-property-context-v1",
  ...
  "/web/offline-storage.js?v=20260824-property-context-v1",
  "/web/research-intent-state.js?v=20260824-property-context-v1",
