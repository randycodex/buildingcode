...
const shellAssetVersion = "20260731-project-activity-row-v250";
...
const shellURLs = [
  ...
  "/web/styles.css?v=20260731-project-activity-row-v250",
  "/web/workboard-assets/workboard.css?v=20260731-workboard-help-v61",
  "/web/app.js?v=20260731-project-activity-row-v250",
  "/web/offline-storage.js?v=20260731-project-activity-row-v250",
