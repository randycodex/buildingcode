...
const shellCacheName = "permitext-pro-shell-v473";
const shellAssetVersion = "20260808-code-question-scroll-v1";
...
const shellURLs = [
  ...
  "/web/styles.css?v=20260808-code-question-scroll-v1",
  ...
  "/web/app.js?v=20260808-code-question-scroll-v1",
  "/web/client-reliability.js?v=20260731-debug-audit-v1",
  "/web/offline-storage.js?v=20260808-code-question-scroll-v1",
  "/web/sync-conflict-resolution.js?v=20260808-code-question-scroll-v1",
