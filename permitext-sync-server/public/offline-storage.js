...
const shellCacheName = "permitext-pro-shell-v625";
const shellAssetVersion = "20260812-notebook-three-row-v44";
...
const shellURLs = [
  ...
  "/web/styles.css?v=20260812-notebook-three-row-v44",
  ...
  "/web/app.js?v=20260812-notebook-three-row-v44",
  "/web/research-progress.js?v=20260812-notebook-three-row-v44",
  "/web/client-reliability.js?v=20260809-session-stability-v1",
  "/web/offline-storage.js?v=20260812-notebook-three-row-v44",
