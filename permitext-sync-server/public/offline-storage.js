...
const shellCacheName = "permitext-pro-shell-v425";
const shellAssetVersion = "20260803-code-question-evidence-v1";
...
const shellURLs = [
  ...
  "/web/styles.css?v=20260803-code-question-evidence-v1",
  "/web/app.js?v=20260803-code-question-evidence-v1",
  "/web/client-reliability.js?v=20260731-debug-audit-v1",
  "/web/offline-storage.js?v=20260803-code-question-evidence-v1",
  "/web/workspace-state.js?v=20260803-code-question-evidence-v1",
  "/web/code-question-workspace.js?v=20260803-code-question-evidence-v1",
  "/web/code-question-define.js?v=20260803-code-question-evidence-v1",
  "/web/code-question-evidence.js?v=20260803-code-question-evidence-v1",
