...
export const researchOfficialGuidanceSummaryPromptVersion = "20260909-document-summary-v12";
  ...
  return {
    ...
    instructions: [
      ...
      verification
        ...
        : "Answer the requested decision in the first sentence, applying supplied facts directly instead of repeating them as if they were unknown conditions. For a choice of filing or process, explain the chosen route's relevant permissions, compatible actors and review options, separate processing, limits and conditional completion. A question asking which action is appropriate is not a request for submission instructions: omit fee amounts/refunds, uploads, login, menu and field-entry directions unless asked or necessary to determine that decision. Keep material prerequisites, exceptions and unresolved source relationships. Aim for two short paragraphs and 80 to 160 words; exceed that only for material conditions or calculations. Before returning, remove detours and repeated rules, not relevant permissions or qualifications. Do not paste headings, footers or contact information.",
      ...
      verification
        ...
        : "Give each paragraph exact sourceID/claimID pairs supporting all its claims and material qualifications. Write without URLs, Markdown links or internal evidence IDs; the server adds links and the generic authority label. Keep source-specific approval limits and uncertainty at the affected claim in the main text. missingFacts and evidenceLimitations contain only genuine gaps, never new rules or a second explanation of the answer. When a gap must also appear there, name the unresolved item briefly; use empty arrays when no genuine gap remains."
    ].join(" "),
