...
export const researchOfficialGuidanceSummaryPromptVersion = "20260909-document-summary-v16";
...
export function researchOfficialGuidanceSummaryRequest({ question, webSupport, context, model, userID, verificationSchema, proposedAnswer } = {}) {
  ...
  return {
    ...
    instructions: [
      ...
      "Preserve each material action paired in a source instruction: review and sign are distinct actions by the named actor. Another actor's acknowledgment of review does not supply that action. Bind the exact passage that establishes the claimed step; another passage from the same page is not interchangeable.",
