...
/**
 * Frozen post-v2-remediation cohort for the Beta 1 Research quality and
 * economics decision. Record its terminal result before another cohort is
 * authorized so this profile cannot spend twice.
 */
export const researchCommercializationBenchmarkV3 = Object.freeze({
  id: "20260827-commercialization-cohort-v3",
  ...
  routingMode: "hybrid",
  applicationCommit: "ac024f04788ae7552e98198c4db9813437691c26",
  completedAt: "2026-08-28T00:07:32.631Z",
  resultStatus: "partial",
  resultFile: "evals/results/2026-08-27T23-55-01-805Z-d91a79dc-85f5-4e76-9374-0d477c1cdcbe.json"
});

export function researchCommercializationBenchmarkV3Environment(environment = process.env) {
  const profile = researchCommercializationBenchmarkV3;
  return {
...
export function validateResearchCommercializationBenchmarkV3() {
  const profile = researchCommercializationBenchmarkV3;
...
async function main() {
  const profile = validateResearchCommercializationBenchmarkV3();
  if (profile.completedAt) {
    throw new Error(
      `The v3 commercialization benchmark already completed at ${profile.completedAt}. ` +
  ...
  const environment = researchCommercializationBenchmarkV3Environment();
  console.log(
