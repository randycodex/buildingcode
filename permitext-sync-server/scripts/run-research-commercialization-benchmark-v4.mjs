...
/**
 * Frozen post-v3-remediation cohort for the Beta 1 Research quality and
 * economics decision. Record its terminal result before another cohort is
 * authorized so this profile cannot spend twice.
 */
export const researchCommercializationBenchmarkV4 = Object.freeze({
  id: "20260828-commercialization-cohort-v4",
  ...
  answerQualityVersion: "20260827-source-bound-paraphrase-repair-v20",
  judgePromptVersion: "20260826-established-facts-v3",
  accurateModel: "gpt-5.6-terra",
  fastModel: "gpt-5.6-luna",
  routingMode: "hybrid",
  applicationCommit: "6fbf0357e553c7ec1f5b48c2dadb26ad8beb156b",
  completedAt: "2026-08-28T00:32:41.585Z",
  resultStatus: "partial",
  resultFile: "evals/results/2026-08-28T00-17-54-753Z-e737d550-b07d-4e8d-9f7b-4bf9e8853009.json"
});

export function researchCommercializationBenchmarkV4Environment(environment = process.env) {
  const profile = researchCommercializationBenchmarkV4;
  return {
...
export function validateResearchCommercializationBenchmarkV4() {
  const profile = researchCommercializationBenchmarkV4;
  ...
  assert.equal(profile.answerQualityVersion, "20260827-source-bound-paraphrase-repair-v20");
...
async function main() {
  const profile = validateResearchCommercializationBenchmarkV4();
  if (profile.completedAt) {
    throw new Error(
      `The v4 commercialization benchmark already completed at ${profile.completedAt}. ` +
  ...
  const environment = researchCommercializationBenchmarkV4Environment();
  console.log(
