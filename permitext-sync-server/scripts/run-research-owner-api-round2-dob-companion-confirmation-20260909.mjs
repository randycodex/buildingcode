...
const firstRoundFile = "evals/results/research-owner-api-round2-live-dob-safety-confirmation-2026-09-09.json";
...
const repairedCaseIDs = ["DOBNOW-003", "DOBNOW-004", "DOBNOW-006", "DOBNOW-012"];
const newCaseIDs = ["DOBNOW-014", "DOBNOW-015", "DOBNOW-016", "DOBNOW-017", "DOBNOW-022", "DOBNOW-023", "DOBNOW-024"];
...
assert.equal(roundPreviousConservativeUSD, 6.188751);
const profile = { schema: "permitext-owner-api-round2-dob-companion-confirmation-v1", sourceCommit,
  authorization: "Owner explicitly authorized fresh API tests with $8 currently available and requested notice if more is needed. This is a new $8 round; historical costs stay separate. This single-use batch confirms four repaired DOB cases and attempts seven untested DOB workflow cases, once each; it retains all failures from earlier batches. Their original scenarios and questions are preserved with the packet's shared DOB NOW workflow context, explicitly recovered and validated independently of the answers. It dispatches only turns passing offline preflight. Maximum $1.25 for the batch within the remaining $8 round allowance. Each next turn requires a full $0.50 remaining conservative allowance. No Project workflow tests or deployment.",
  ...
  maximumCumulativeSpendUSD: Math.min(1.25, Number((8 - roundPreviousConservativeUSD).toFixed(6))), maximumTurnSpendUSD: 0.5, maximumTurns: 11, maximumProviderRequests: 55, maximumProviderRequestsPerTurn: 5,
...
const preflightURL = new URL("evals/results/research-owner-api-round2-dob-companion-confirmation-preflight-2026-09-09.json", root);
const resultURL = new URL("evals/results/research-owner-api-round2-live-dob-companion-confirmation-2026-09-09.json", root);
const sourceFiles = ["app.mjs", "research-answer-presentation.mjs", "research-official-guidance-summary.mjs", "evals/research-answer-key-amendments.json", "research-answer-quality.mjs", "research-focused-technical-scope.mjs", "research-conversation-topic.mjs", "research-technical-topic-routes.mjs", "evidence-discovery.mjs", "research-conversation-facts.mjs", "research-fact-qualification.mjs", "research-source-policy.mjs", "research-official-html-attribution.mjs", "research-official-pdf-attribution.mjs", "research-official-pdf-ranking.mjs", "research-official-pdf-worker.mjs", "research-dob-workflow-routing.mjs", "evals/research-answer-key-reconciliation.mjs", "research-config.mjs", "research-cost-usage.mjs", "research-provider-client.mjs", "research-zoning-planner.mjs", "research-zoning-temporal-application.mjs", "research-zoning-safety.mjs",
  ...
  "evals/research-reconciled-answer-key.json", "evals/research-owner-code-candidates.json", "evals/research-owner-code-review.mjs", "evals/research-owner-http-request-binding.mjs", "scripts/run-research-owner-api-round2-dob-companion-confirmation-20260909.mjs"];
...
try {
  const signed = await request("/account/sign-in", { credential: { provider: "web", providerUserID: randomUUID(), displayName: "Isolated owner DOB companion diagnostic" } });
