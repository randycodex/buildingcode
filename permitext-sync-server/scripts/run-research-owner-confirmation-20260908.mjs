// One bounded attempt at the eight-turn owner-authorized source-selection confirmation.
...
assert(previousConservativeSpendUSD + 8 * 0.6 <= 8, "Retain the owner's total authorization across runs.");
const profile = {
  schema: "permitext-owner-live-source-confirmation-20260908-v1",
  ...
  maximumTurnSpendUSD: 0.6,
  maximumTurns: 8,
  absoluteTurnSumCeilingUSD: 4.8,
  repetitions: 1,
...
const resultURL = new URL("evals/results/research-owner-live-source-confirmation-2026-09-08.json", serverRoot);
...
Object.assign(process.env, {
  ...
  PERMITEXT_RESEARCH_MAX_REQUEST_USD: "0.6",
  PERMITEXT_RESEARCH_USER_DAILY_CAP_USD: "5",
  PERMITEXT_RESEARCH_USER_MONTHLY_CAP_USD: "5",
  PERMITEXT_RESEARCH_DAILY_CAP_USD: "5",
  PERMITEXT_RESEARCH_MONTHLY_CAP_USD: "5",
