...
// Definition and terminology sections remain plain. Inline declarations in mixed
// sections need occurrence exclusions, including Living room in §27-2058(a)(4).
...
export function bindHMCGeneralApplicability(book,chapterSources){
 ...
 return {...book,terms:book.terms.map(term=>labels.has(term.term)&&term.sectionNumber==='27-2004'?{...term,applicability:'definition-chapter',applicableChapters:['1','2','3','4','5'],...hmcGeneralSectionExclusions(),...(term.term==='Living room'?{excludedOccurrences:[{section:'27-2058',phrases:[{text:'A living room does not include a kitchen under this paragraph',occurrence:0}]}]}:{})}:term)};
}
