...
export function bindHMCPrivateDwelling(book,chapterSources){
 ...
 return {...book,terms:book.terms.map(t=>t===originals[0]?{...t,applicability:'definition-chapter',applicableChapters:['1','2','3','4','5'],excludedSections:[...hmcGeneralExcludedSections,'27-2045']}:t)};
}
