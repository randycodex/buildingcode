...
for (const text of [
  ...
  "Each substitute must be a dedicated plumbing fixture with a faucet designed to fill a container at least 10 inches (254 mm) high, located adjacent to or readily visible from the location of a drinking fountain conforming to PC § 410.1.",
