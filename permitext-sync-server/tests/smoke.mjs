  ...
  try {
    ...
    assert(
      workspaceScript.text.includes("function linkInlineCodeReferences") &&
        ...
        webRoot.text.includes('/web/app.js?v=20260815-conditional-source-highlight-v249'),
    ...
    assert(
      ...
      webRoot.text.includes('/web/styles.css?v=20260815-conditional-source-highlight-v249'),
