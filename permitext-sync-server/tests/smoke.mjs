  ...
  try {
    ...
    assert(
      workspaceScript.text.includes("function linkInlineCodeReferences") &&
        ...
        webRoot.text.includes('/web/app.js?v=20260801-workboard-canvas-restore-v345'),
    ...
    assert(
      workspaceScript.text.includes("instance.projectsArchiveMode = Boolean(overrides.projectsArchiveMode)") &&
        ...
        webRoot.text.includes('/web/styles.css?v=20260801-workboard-canvas-restore-v345'),
