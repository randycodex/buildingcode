  ...
  try {
    ...
    assert(
      workspaceScript.text.includes("function linkInlineCodeReferences") &&
        ...
        webRoot.text.includes('/web/app.js?v=20260816-notebook-professional-analysis-v275'),
    ...
    assert(
      ...
      webRoot.text.includes('/web/styles.css?v=20260816-notebook-professional-analysis-v275'),
