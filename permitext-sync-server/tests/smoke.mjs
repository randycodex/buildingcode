  ...
  try {
    ...
    assert(
      workspaceScript.text.includes("function linkInlineCodeReferences") &&
        ...
        webRoot.text.includes('/web/app.js?v=20260816-notebook-writing-surface-v276'),
    ...
    assert(
      ...
      webRoot.text.includes('/web/styles.css?v=20260816-notebook-writing-surface-v276'),
