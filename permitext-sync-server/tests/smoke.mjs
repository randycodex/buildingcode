  ...
  try {
    ...
    assert(
      workspaceScript.text.includes("function linkInlineCodeReferences") &&
        ...
        webRoot.text.includes('/web/app.js?v=20260816-research-full-width-rows-v302'),
    ...
    assert(
      ...
      webRoot.text.includes('/web/styles.css?v=20260816-research-full-width-rows-v302'),
