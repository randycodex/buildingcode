  ...
  try {
    ...
    assert(
      workspaceScript.text.includes("function linkInlineCodeReferences") &&
        ...
        webRoot.text.includes('/web/app.js?v=20260813-conversation-project-pill-v105'),
    ...
    assert(
      ...
      webRoot.text.includes('/web/styles.css?v=20260813-conversation-project-pill-v104'),
