  ...
  try {
    ...
    assert(
      workspaceScript.text.includes("function linkInlineCodeReferences") &&
        ...
        webRoot.text.includes('/web/app.js?v=20260801-dark-editor-white-v349'),
    ...
    assert(
      workspaceScript.text.includes("instance.projectsArchiveMode = Boolean(overrides.projectsArchiveMode)") &&
        ...
        workspaceStyles.text.includes("border-color: #000 !important;") &&
        ...
        webRoot.text.includes('/web/styles.css?v=20260801-dark-editor-white-v349'),
