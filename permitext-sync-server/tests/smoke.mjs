  ...
  try {
    ...
    assert(
      workspaceScript.text.includes("function linkInlineCodeReferences") &&
        ...
        webRoot.text.includes('/web/app.js?v=20260812-research-history-selection-v41'),
    ...
    assert(
      ...
      webRoot.text.includes('/web/styles.css?v=20260812-research-history-selection-v41'),
