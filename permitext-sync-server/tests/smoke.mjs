  ...
  try {
    ...
    assert(
      workspaceScript.text.includes("function linkInlineCodeReferences") &&
        ...
        webRoot.text.includes('/web/app.js?v=20260808-project-column-no-activity-v1'),
    ...
    assert(
      workspaceScript.text.includes("instance.projectsArchiveMode = Boolean(overrides.projectsArchiveMode)") &&
        ...
        webRoot.text.includes('/web/styles.css?v=20260808-project-column-no-activity-v1'),
    ...
    assert(
      workspaceScript.text.includes("async function convergeServerNewerSyncConflicts(account)") &&
        ...
        workspaceScript.text.includes('import { syncConflictRecordsMatch } from "./sync-conflict-resolution.js?v=20260808-project-column-no-activity-v1"') &&
