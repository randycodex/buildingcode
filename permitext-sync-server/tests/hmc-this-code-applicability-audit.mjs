...
test('This code complete corpus proposal excludes external referrals and defining prose',()=>{
 assert.deepEqual(report.counts,{definition:6,external:7,inlineDefinition:2,candidate:89});assert.equal(report.matches,89);assert.equal(report.original.applicability,'definition-chapter');assert.equal(report.paragraphs.length,84);
});
