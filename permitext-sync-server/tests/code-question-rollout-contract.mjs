...
assert.match(workspaceHTML, /styles\.css\?v=20260809-research-source-dedupe-v1/);
assert.match(serviceWorker, /permitext-pro-shell-v522/);
assert.match(serviceWorker, /styles\.css\?v=20260809-research-source-dedupe-v1/);
