...
assert.match(workspaceHTML, /styles\.css\?v=20260812-topbar-focus-v48/);
assert.match(serviceWorker, /permitext-pro-shell-v629/);
assert.match(workspaceScript, /paneID\?\.startsWith\("research:conversation:"\)/);
assert.match(serviceWorker, /styles\.css\?v=20260812-topbar-focus-v48/);
