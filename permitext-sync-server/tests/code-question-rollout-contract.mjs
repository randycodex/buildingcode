...
assert.match(workspaceHTML, /styles\.css\?v=20260816-project-tool-transfer-v333/);
assert.match(serviceWorker, /permitext-pro-shell-v697/);
assert.match(workspaceScript, /paneID\?\.startsWith\("research:conversation:"\)/);
assert.match(serviceWorker, /styles\.css\?v=20260816-project-tool-transfer-v333/);
