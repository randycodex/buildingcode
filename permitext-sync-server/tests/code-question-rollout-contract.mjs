...
assert.match(workspaceHTML, /styles\.css\?v=20260812-notebook-label-v49/);
assert.match(serviceWorker, /permitext-pro-shell-v630/);
assert.match(workspaceScript, /paneID\?\.startsWith\("research:conversation:"\)/);
assert.match(serviceWorker, /styles\.css\?v=20260812-notebook-label-v49/);
