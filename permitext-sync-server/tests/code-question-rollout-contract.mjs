...
assert.match(workspaceHTML, /styles\.css\?v=20260812-research-progress-v25/);
assert.match(serviceWorker, /permitext-pro-shell-v619/);
assert.match(workspaceScript, /paneID\?\.startsWith\("research:conversation:"\)/);
assert.match(serviceWorker, /styles\.css\?v=20260812-research-progress-v25/);
