...
assert.match(workspaceHTML, /styles\.css\?v=20260809-research-source-label-layout-v1/);
assert.match(serviceWorker, /permitext-pro-shell-v523/);
assert.match(serviceWorker, /styles\.css\?v=20260809-research-source-label-layout-v1/);
