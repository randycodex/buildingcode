...
assert.match(workspaceHTML, /styles\.css\?v=20260815-settings-fixed-header-v241/);
assert.match(serviceWorker, /permitext-pro-shell-v693/);
assert.match(workspaceScript, /paneID\?\.startsWith\("research:conversation:"\)/);
assert.match(serviceWorker, /styles\.css\?v=20260815-settings-fixed-header-v241/);
