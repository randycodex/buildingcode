...
assert.match(workspaceHTML, /styles\.css\?v=20260812-report-floating-menu-v61/);
assert.match(serviceWorker, /permitext-pro-shell-v642/);
assert.match(workspaceScript, /paneID\?\.startsWith\("research:conversation:"\)/);
assert.match(serviceWorker, /styles\.css\?v=20260812-report-floating-menu-v61/);
