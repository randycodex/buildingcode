...
assert.match(workspaceHTML, /styles\.css\?v=20260811-search-history-clipping-v1/);
assert.match(serviceWorker, /permitext-pro-shell-v587/);
assert.match(workspaceScript, /paneID\?\.startsWith\("research:conversation:"\)/);
assert.match(serviceWorker, /styles\.css\?v=20260811-search-history-clipping-v1/);
