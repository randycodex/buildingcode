...
assert.match(workspaceHTML, /styles\.css\?v=20260812-project-evidence-hide-v43/);
assert.match(serviceWorker, /permitext-pro-shell-v624/);
assert.match(workspaceScript, /paneID\?\.startsWith\("research:conversation:"\)/);
assert.match(serviceWorker, /styles\.css\?v=20260812-project-evidence-hide-v43/);
