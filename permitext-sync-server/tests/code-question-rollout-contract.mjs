...
assert.match(workspaceHTML, /styles\.css\?v=20260813-recent-preview-hydration-v132/);
assert.match(serviceWorker, /permitext-pro-shell-v682/);
assert.match(workspaceScript, /paneID\?\.startsWith\("research:conversation:"\)/);
assert.match(serviceWorker, /styles\.css\?v=20260813-recent-preview-hydration-v132/);
