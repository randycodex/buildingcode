...
assert.match(workspaceHTML, /styles\.css\?v=20260817-native-research-notebook-v346/);
assert.match(serviceWorker, /permitext-pro-shell-v700/);
assert.match(workspaceScript, /paneID\?\.startsWith\("research:conversation:"\)/);
assert.match(serviceWorker, /styles\.css\?v=20260817-native-research-notebook-v346/);
