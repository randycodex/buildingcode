...
assert.match(workspaceHTML, /styles\.css\?v=20260809-flat-evidence-candidates-v1/);
assert.match(serviceWorker, /permitext-pro-shell-v507/);
assert.match(serviceWorker, /styles\.css\?v=20260809-flat-evidence-candidates-v1/);
...
assert.match(workspaceStyles, /\.evidence-candidate-card \{[\s\S]*?border-top: 1px solid var\(--border\);[\s\S]*?border-radius: 0;[\s\S]*?background: transparent;/);
