...
assert.match(workspaceHTML, /styles\.css\?v=20260809-candidate-controls-background-v1/);
assert.match(serviceWorker, /permitext-pro-shell-v520/);
assert.match(serviceWorker, /styles\.css\?v=20260809-candidate-controls-background-v1/);
