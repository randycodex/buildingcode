...
assert.match(workspaceHTML, /styles\.css\?v=20260809-research-evidence-copy-v1/);
assert.match(serviceWorker, /permitext-pro-shell-v548/);
assert.match(serviceWorker, /styles\.css\?v=20260809-research-evidence-copy-v1/);
