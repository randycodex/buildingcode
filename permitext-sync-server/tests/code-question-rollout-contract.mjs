...
assert.match(workspaceHTML, /styles\.css\?v=20260817-research-multicorpus-v349/);
assert.match(serviceWorker, /permitext-pro-shell-v703/);
assert.match(workspaceScript, /paneID\?\.startsWith\("research:conversation:"\)/);
assert.match(serviceWorker, /styles\.css\?v=20260817-research-multicorpus-v349/);
