...
assert.match(workspaceHTML, /styles\.css\?v=20260812-report-details-v59/);
assert.match(serviceWorker, /permitext-pro-shell-v640/);
assert.match(workspaceScript, /paneID\?\.startsWith\("research:conversation:"\)/);
assert.match(serviceWorker, /styles\.css\?v=20260812-report-details-v59/);
