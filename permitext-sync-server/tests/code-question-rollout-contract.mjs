...
assert.match(workspaceHTML, /styles\.css\?v=20260809-decision-entry-composer-v1/);
assert.match(serviceWorker, /permitext-pro-shell-v552/);
assert.match(serviceWorker, /styles\.css\?v=20260809-decision-entry-composer-v1/);
