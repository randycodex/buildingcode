...
assert.match(workspaceHTML, /styles\.css\?v=20260809-project-column-cleanup-v1/);
assert.match(serviceWorker, /permitext-pro-shell-v516/);
assert.match(serviceWorker, /styles\.css\?v=20260809-project-column-cleanup-v1/);
