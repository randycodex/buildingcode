...
assert.match(workspaceHTML, /styles\.css\?v=20260812-report-copy-cleanup-v66/);
assert.match(serviceWorker, /permitext-pro-shell-v647/);
assert.match(workspaceScript, /paneID\?\.startsWith\("research:conversation:"\)/);
assert.match(serviceWorker, /styles\.css\?v=20260812-report-copy-cleanup-v66/);
