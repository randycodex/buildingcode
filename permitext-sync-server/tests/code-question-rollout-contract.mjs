...
assert.match(workspaceHTML, /styles\.css\?v=20260814-reader-nav-filter-v134/);
assert.match(serviceWorker, /permitext-pro-shell-v684/);
assert.match(workspaceScript, /paneID\?\.startsWith\("research:conversation:"\)/);
assert.match(serviceWorker, /styles\.css\?v=20260814-reader-nav-filter-v134/);
