...
assert.match(workspaceHTML, /styles\.css\?v=20260813-structured-project-facts-v125/);
assert.match(serviceWorker, /permitext-pro-shell-v675/);
assert.match(workspaceScript, /paneID\?\.startsWith\("research:conversation:"\)/);
assert.match(serviceWorker, /styles\.css\?v=20260813-structured-project-facts-v125/);
