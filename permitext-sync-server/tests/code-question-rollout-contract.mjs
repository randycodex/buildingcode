...
assert.match(workspaceHTML, /styles\.css\?v=20260809-section-detail-type-v1/);
assert.match(serviceWorker, /permitext-pro-shell-v547/);
assert.match(serviceWorker, /styles\.css\?v=20260809-section-detail-type-v1/);
