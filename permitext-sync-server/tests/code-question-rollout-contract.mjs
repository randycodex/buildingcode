...
assert.match(workspaceHTML, /styles\.css\?v=20260811-selection-actions-v1/);
assert.match(serviceWorker, /permitext-pro-shell-v604/);
assert.match(workspaceScript, /paneID\?\.startsWith\("research:conversation:"\)/);
assert.match(serviceWorker, /styles\.css\?v=20260811-selection-actions-v1/);
