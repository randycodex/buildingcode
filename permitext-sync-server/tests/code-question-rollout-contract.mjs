...
assert.match(workspaceHTML, /styles\.css\?v=20260812-report-idle-status-v58/);
assert.match(serviceWorker, /permitext-pro-shell-v639/);
assert.match(workspaceScript, /paneID\?\.startsWith\("research:conversation:"\)/);
assert.match(serviceWorker, /styles\.css\?v=20260812-report-idle-status-v58/);
