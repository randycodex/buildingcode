...
assert.match(workspaceHTML, /styles\.css\?v=20260812-notebook-header-order-v56/);
assert.match(serviceWorker, /permitext-pro-shell-v637/);
assert.match(workspaceScript, /paneID\?\.startsWith\("research:conversation:"\)/);
assert.match(serviceWorker, /styles\.css\?v=20260812-notebook-header-order-v56/);
