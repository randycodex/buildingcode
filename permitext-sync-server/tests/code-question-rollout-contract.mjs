...
assert.match(workspaceHTML, /styles\.css\?v=20260815-notebook-size-order-v243/);
assert.match(serviceWorker, /permitext-pro-shell-v695/);
assert.match(workspaceScript, /paneID\?\.startsWith\("research:conversation:"\)/);
assert.match(serviceWorker, /styles\.css\?v=20260815-notebook-size-order-v243/);
