...
assert.match(workspaceHTML, /styles\.css\?v=20260809-black-research-bubble-v1/);
assert.match(serviceWorker, /permitext-pro-shell-v565/);
assert.match(serviceWorker, /styles\.css\?v=20260809-black-research-bubble-v1/);
