...
assert.match(workspaceHTML, /styles\.css\?v=20260809-research-starter-bubble-removal-v1/);
assert.match(serviceWorker, /permitext-pro-shell-v524/);
assert.match(serviceWorker, /styles\.css\?v=20260809-research-starter-bubble-removal-v1/);
