...
assert.match(workspaceHTML, /styles\.css\?v=20260809-numbered-decision-list-v1/);
assert.match(serviceWorker, /permitext-pro-shell-v562/);
assert.match(serviceWorker, /styles\.css\?v=20260809-numbered-decision-list-v1/);
