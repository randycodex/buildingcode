...
assert.match(workspaceHTML, /styles\.css\?v=20260811-pro-research-unlimited-v1/);
assert.match(serviceWorker, /permitext-pro-shell-v597/);
assert.match(workspaceScript, /paneID\?\.startsWith\("research:conversation:"\)/);
assert.match(serviceWorker, /styles\.css\?v=20260811-pro-research-unlimited-v1/);
