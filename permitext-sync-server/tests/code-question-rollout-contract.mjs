...
assert.match(workspaceHTML, /styles\.css\?v=20260812-notebook-collapse-v50/);
assert.match(serviceWorker, /permitext-pro-shell-v631/);
assert.match(workspaceScript, /paneID\?\.startsWith\("research:conversation:"\)/);
assert.match(serviceWorker, /styles\.css\?v=20260812-notebook-collapse-v50/);
