...
assert.match(workspaceHTML, /styles\.css\?v=20260809-candidate-queue-v1/);
assert.match(serviceWorker, /permitext-pro-shell-v515/);
assert.match(serviceWorker, /styles\.css\?v=20260809-candidate-queue-v1/);
