...
assert.match(workspaceHTML, /styles\.css\?v=20260814-multiple-projects-label-v228/);
assert.match(serviceWorker, /permitext-pro-shell-v686/);
assert.match(workspaceScript, /paneID\?\.startsWith\("research:conversation:"\)/);
assert.match(serviceWorker, /styles\.css\?v=20260814-multiple-projects-label-v228/);
