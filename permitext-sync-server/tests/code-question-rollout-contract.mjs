...
assert.match(workspaceHTML, /styles\.css\?v=20260817-notebook-menu-motion-v359/);
assert.match(serviceWorker, /permitext-pro-shell-v711/);
assert.match(workspaceScript, /paneID\?\.startsWith\("research:conversation:"\)/);
assert.match(serviceWorker, /styles\.css\?v=20260817-notebook-menu-motion-v359/);
