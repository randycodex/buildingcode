...
assert.match(workspaceHTML, /styles\.css\?v=20260809-project-summary-labels-v1/);
assert.match(serviceWorker, /permitext-pro-shell-v559/);
assert.match(serviceWorker, /styles\.css\?v=20260809-project-summary-labels-v1/);
