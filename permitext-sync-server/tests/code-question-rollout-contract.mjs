...
assert.match(workspaceHTML, /styles\.css\?v=20260812-report-drag-sections-v64/);
assert.match(serviceWorker, /permitext-pro-shell-v645/);
assert.match(workspaceScript, /paneID\?\.startsWith\("research:conversation:"\)/);
assert.match(serviceWorker, /styles\.css\?v=20260812-report-drag-sections-v64/);
