...
assert.match(workspaceHTML, /styles\.css\?v=20260809-research-project-summary-removal-v1/);
assert.match(serviceWorker, /permitext-pro-shell-v521/);
assert.match(serviceWorker, /styles\.css\?v=20260809-research-project-summary-removal-v1/);
