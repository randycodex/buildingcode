...
assert.match(workspaceScript, /evidenceReviewedSummary\.textContent = result\.mode === "project_context"/);
assert.match(workspaceScript, /\? "Project facts reviewed"[\s\S]*?: "Evidence reviewed"/);
