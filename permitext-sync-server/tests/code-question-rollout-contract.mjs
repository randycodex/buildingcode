...
assert.match(workspaceHTML, /styles\.css\?v=20260812-report-idle-hidden-v60/);
assert.match(serviceWorker, /permitext-pro-shell-v641/);
assert.match(workspaceScript, /paneID\?\.startsWith\("research:conversation:"\)/);
assert.match(serviceWorker, /styles\.css\?v=20260812-report-idle-hidden-v60/);
