...
assert.match(workspaceHTML, /styles\.css\?v=20260812-notebook-research-hidden-v52/);
assert.match(serviceWorker, /permitext-pro-shell-v633/);
assert.match(workspaceScript, /paneID\?\.startsWith\("research:conversation:"\)/);
assert.match(serviceWorker, /styles\.css\?v=20260812-notebook-research-hidden-v52/);
