...
assert.match(workspaceHTML, /styles\.css\?v=20260811-research-clear-v1/);
assert.match(serviceWorker, /permitext-pro-shell-v570/);
assert.match(serviceWorker, /styles\.css\?v=20260811-research-clear-v1/);
