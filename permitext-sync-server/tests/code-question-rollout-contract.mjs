...
assert.match(workspaceHTML, /styles\.css\?v=20260812-notebook-three-row-v44/);
assert.match(serviceWorker, /permitext-pro-shell-v625/);
assert.match(workspaceScript, /paneID\?\.startsWith\("research:conversation:"\)/);
assert.match(serviceWorker, /styles\.css\?v=20260812-notebook-three-row-v44/);
