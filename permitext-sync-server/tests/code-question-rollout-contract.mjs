...
assert.match(workspaceHTML, /styles\.css\?v=20260809-project-tile-label-v1/);
assert.match(serviceWorker, /permitext-pro-shell-v546/);
assert.match(serviceWorker, /styles\.css\?v=20260809-project-tile-label-v1/);
