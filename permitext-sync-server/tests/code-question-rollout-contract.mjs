...
assert.match(workspaceHTML, /styles\.css\?v=20260812-report-header-v55/);
assert.match(serviceWorker, /permitext-pro-shell-v636/);
assert.match(workspaceScript, /paneID\?\.startsWith\("research:conversation:"\)/);
assert.match(serviceWorker, /styles\.css\?v=20260812-report-header-v55/);
