...
assert.match(workspaceHTML, /styles\.css\?v=20260811-research-composer-v2/);
assert.match(serviceWorker, /permitext-pro-shell-v584/);
assert.match(workspaceScript, /paneID\?\.startsWith\("research:conversation:"\)/);
assert.match(serviceWorker, /styles\.css\?v=20260811-research-composer-v2/);
