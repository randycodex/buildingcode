...
assert.match(workspaceHTML, /styles\.css\?v=20260809-decision-id-weight-v1/);
assert.match(serviceWorker, /permitext-pro-shell-v555/);
assert.match(serviceWorker, /styles\.css\?v=20260809-decision-id-weight-v1/);
