...
assert.match(workspaceHTML, /styles\.css\?v=20260812-report-copy-cleanup-v67/);
assert.match(serviceWorker, /permitext-pro-shell-v648/);
assert.match(workspaceScript, /paneID\?\.startsWith\("research:conversation:"\)/);
assert.match(serviceWorker, /styles\.css\?v=20260812-report-copy-cleanup-v67/);
