...
assert.match(workspaceHTML, /styles\.css\?v=20260809-question-list-v2/);
assert.match(serviceWorker, /permitext-pro-shell-v541/);
assert.match(serviceWorker, /styles\.css\?v=20260809-question-list-v2/);
