...
assert.match(workspaceHTML, /styles\.css\?v=20260820-ux-alignment-phase1-v2/);
assert.match(serviceWorker, /permitext-pro-shell-v716/);
assert.match(workspaceScript, /paneID\?\.startsWith\("research:conversation:"\)/);
assert.match(serviceWorker, /styles\.css\?v=20260820-ux-alignment-phase1-v2/);
