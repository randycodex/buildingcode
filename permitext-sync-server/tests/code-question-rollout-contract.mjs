...
assert.match(workspaceHTML, /styles\.css\?v=20260810-sync-performance-v1/);
assert.match(serviceWorker, /permitext-pro-shell-v566/);
assert.match(serviceWorker, /styles\.css\?v=20260810-sync-performance-v1/);
