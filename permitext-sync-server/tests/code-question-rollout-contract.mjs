...
assert.match(workspaceHTML, /styles\.css\?v=20260820-ux-alignment-phase2-v1/);
assert.match(serviceWorker, /permitext-pro-shell-v717/);
assert.match(workspaceScript, /paneID\?\.startsWith\("research:conversation:"\)/);
assert.match(serviceWorker, /styles\.css\?v=20260820-ux-alignment-phase2-v1/);
