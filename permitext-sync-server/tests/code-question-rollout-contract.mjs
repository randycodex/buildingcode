...
assert.match(workspaceHTML, /styles\.css\?v=20260812-search-filter-focus-v51/);
assert.match(serviceWorker, /permitext-pro-shell-v632/);
assert.match(workspaceScript, /paneID\?\.startsWith\("research:conversation:"\)/);
assert.match(serviceWorker, /styles\.css\?v=20260812-search-filter-focus-v51/);
