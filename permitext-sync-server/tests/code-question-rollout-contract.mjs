...
assert.match(workspaceHTML, /styles\.css\?v=20260812-release-surface-v39/);
assert.match(serviceWorker, /permitext-pro-shell-v620/);
assert.match(workspaceScript, /paneID\?\.startsWith\("research:conversation:"\)/);
assert.match(serviceWorker, /styles\.css\?v=20260812-release-surface-v39/);
