...
assert.match(workspaceHTML, /styles\.css\?v=20260809-research-composer-copy-v1/);
assert.match(serviceWorker, /permitext-pro-shell-v549/);
assert.match(serviceWorker, /styles\.css\?v=20260809-research-composer-copy-v1/);
