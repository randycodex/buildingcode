...
assert.match(workspaceHTML, /styles\.css\?v=20260808-project-column-no-activity-v1/);
assert.match(serviceWorker, /permitext-pro-shell-v471/);
assert.match(serviceWorker, /styles\.css\?v=20260808-project-column-no-activity-v1/);
