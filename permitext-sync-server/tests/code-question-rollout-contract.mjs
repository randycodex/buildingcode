...
assert.match(workspaceHTML, /styles\.css\?v=20260809-pinned-answer-feedback-v1/);
assert.match(serviceWorker, /permitext-pro-shell-v564/);
assert.match(serviceWorker, /styles\.css\?v=20260809-pinned-answer-feedback-v1/);
