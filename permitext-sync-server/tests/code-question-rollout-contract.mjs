...
assert.match(workspaceHTML, /styles\.css\?v=20260811-project-select-all-v1/);
assert.match(serviceWorker, /permitext-pro-shell-v613/);
assert.match(workspaceScript, /paneID\?\.startsWith\("research:conversation:"\)/);
assert.match(serviceWorker, /styles\.css\?v=20260811-project-select-all-v1/);
