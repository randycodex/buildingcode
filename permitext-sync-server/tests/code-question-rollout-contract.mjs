...
assert.match(workspaceHTML, /styles\.css\?v=20260809-candidate-controls-v1/);
assert.match(serviceWorker, /permitext-pro-shell-v518/);
assert.match(serviceWorker, /styles\.css\?v=20260809-candidate-controls-v1/);
