...
assert.match(workspaceHTML, /styles\.css\?v=20260812-report-delete-icon-v63/);
assert.match(serviceWorker, /permitext-pro-shell-v644/);
assert.match(workspaceScript, /paneID\?\.startsWith\("research:conversation:"\)/);
assert.match(serviceWorker, /styles\.css\?v=20260812-report-delete-icon-v63/);
