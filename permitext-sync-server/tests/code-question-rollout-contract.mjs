...
assert.match(workspaceHTML, /styles\.css\?v=20260817-research-conversation-titles-v361/);
assert.match(serviceWorker, /permitext-pro-shell-v713/);
assert.match(workspaceScript, /paneID\?\.startsWith\("research:conversation:"\)/);
assert.match(serviceWorker, /styles\.css\?v=20260817-research-conversation-titles-v361/);
