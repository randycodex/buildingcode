...
assert.match(workspaceHTML, /styles\.css\?v=20260815-research-context-defaults-v242/);
assert.match(serviceWorker, /permitext-pro-shell-v694/);
assert.match(workspaceScript, /paneID\?\.startsWith\("research:conversation:"\)/);
assert.match(serviceWorker, /styles\.css\?v=20260815-research-context-defaults-v242/);
