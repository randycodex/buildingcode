...
assert.match(workspaceHTML, /styles\.css\?v=20260811-recently-viewed-spacing-v2/);
assert.match(serviceWorker, /permitext-pro-shell-v600/);
assert.match(workspaceScript, /paneID\?\.startsWith\("research:conversation:"\)/);
assert.match(serviceWorker, /styles\.css\?v=20260811-recently-viewed-spacing-v2/);
