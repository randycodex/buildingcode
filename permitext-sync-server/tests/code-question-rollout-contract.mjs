...
assert.match(workspaceHTML, /styles\.css\?v=20260811-research-code-basis-v2/);
assert.match(serviceWorker, /permitext-pro-shell-v582/);
assert.match(workspaceScript, /paneID\?\.startsWith\("research:conversation:"\)/);
assert.match(serviceWorker, /styles\.css\?v=20260811-research-code-basis-v2/);
