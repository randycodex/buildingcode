...
assert.match(workspaceHTML, /styles\.css\?v=20260809-concise-supported-points-v1/);
assert.match(serviceWorker, /permitext-pro-shell-v563/);
assert.match(serviceWorker, /styles\.css\?v=20260809-concise-supported-points-v1/);
