...
assert.match(workspaceHTML, /styles\.css\?v=20260816-notebook-professional-analysis-v275/);
assert.match(serviceWorker, /permitext-pro-shell-v697/);
assert.match(workspaceScript, /paneID\?\.startsWith\("research:conversation:"\)/);
assert.match(serviceWorker, /styles\.css\?v=20260816-notebook-professional-analysis-v275/);
