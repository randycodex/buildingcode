...
assert.match(workspaceHTML, /styles\.css\?v=20260812-notebook-card-align-v53/);
assert.match(serviceWorker, /permitext-pro-shell-v634/);
assert.match(workspaceScript, /paneID\?\.startsWith\("research:conversation:"\)/);
assert.match(serviceWorker, /styles\.css\?v=20260812-notebook-card-align-v53/);
