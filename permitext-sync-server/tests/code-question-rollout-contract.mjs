...
assert.match(workspaceHTML, /styles\.css\?v=20260815-selection-anchor-v244/);
assert.match(serviceWorker, /permitext-pro-shell-v696/);
assert.match(workspaceScript, /paneID\?\.startsWith\("research:conversation:"\)/);
assert.match(serviceWorker, /styles\.css\?v=20260815-selection-anchor-v244/);
