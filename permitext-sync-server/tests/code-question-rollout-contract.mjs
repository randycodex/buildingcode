...
assert.match(workspaceHTML, /styles\.css\?v=20260812-single-report-template-v65/);
assert.match(serviceWorker, /permitext-pro-shell-v646/);
assert.match(workspaceScript, /paneID\?\.startsWith\("research:conversation:"\)/);
assert.match(serviceWorker, /styles\.css\?v=20260812-single-report-template-v65/);
