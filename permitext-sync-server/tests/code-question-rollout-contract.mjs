...
assert.match(workspaceHTML, /styles\.css\?v=20260817-instant-project-selection-v360/);
assert.match(serviceWorker, /permitext-pro-shell-v712/);
assert.match(workspaceScript, /paneID\?\.startsWith\("research:conversation:"\)/);
assert.match(serviceWorker, /styles\.css\?v=20260817-instant-project-selection-v360/);
