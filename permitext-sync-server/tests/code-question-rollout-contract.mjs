...
assert.match(workspaceHTML, /styles\.css\?v=20260809-compact-research-feedback-v2/);
assert.match(serviceWorker, /permitext-pro-shell-v561/);
assert.match(serviceWorker, /styles\.css\?v=20260809-compact-research-feedback-v2/);
