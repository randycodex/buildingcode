...
assert.match(workspaceHTML, /styles\.css\?v=20260812-workspace-tabs-right-v47/);
assert.match(serviceWorker, /permitext-pro-shell-v628/);
assert.match(workspaceScript, /paneID\?\.startsWith\("research:conversation:"\)/);
assert.match(serviceWorker, /styles\.css\?v=20260812-workspace-tabs-right-v47/);
