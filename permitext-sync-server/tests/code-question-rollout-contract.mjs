...
assert.match(workspaceHTML, /styles\.css\?v=20260811-project-card-first-frame-v1/);
assert.match(serviceWorker, /permitext-pro-shell-v603/);
assert.match(workspaceScript, /paneID\?\.startsWith\("research:conversation:"\)/);
assert.match(serviceWorker, /styles\.css\?v=20260811-project-card-first-frame-v1/);
