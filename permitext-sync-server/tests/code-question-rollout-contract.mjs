...
assert.match(workspaceHTML, /styles\.css\?v=20260808-typography-v2/);
assert.match(serviceWorker, /permitext-pro-shell-v445/);
assert.match(serviceWorker, /styles\.css\?v=20260808-typography-v2/);
