...
assert.match(workspaceHTML, /styles\.css\?v=20260811-reset-column-widths-v1/);
assert.match(serviceWorker, /permitext-pro-shell-v598/);
assert.match(workspaceScript, /paneID\?\.startsWith\("research:conversation:"\)/);
assert.match(serviceWorker, /styles\.css\?v=20260811-reset-column-widths-v1/);
