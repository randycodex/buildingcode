...
assert.match(workspaceHTML, /styles\.css\?v=20260809-context-bar-removal-v1/);
assert.match(serviceWorker, /permitext-pro-shell-v514/);
assert.match(serviceWorker, /styles\.css\?v=20260809-context-bar-removal-v1/);
