...
assert.match(workspaceHTML, /styles\.css\?v=20260815-conditional-source-highlight-v249/);
assert.match(serviceWorker, /permitext-pro-shell-v697/);
assert.match(workspaceScript, /paneID\?\.startsWith\("research:conversation:"\)/);
assert.match(serviceWorker, /styles\.css\?v=20260815-conditional-source-highlight-v249/);
