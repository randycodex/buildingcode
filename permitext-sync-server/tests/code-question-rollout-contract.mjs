...
assert.match(workspaceHTML, /styles\.css\?v=20260808-reader-notes-borderless-v1/);
assert.match(serviceWorker, /permitext-pro-shell-v463/);
assert.match(serviceWorker, /styles\.css\?v=20260808-reader-notes-borderless-v1/);
