...
assert.match(workspaceHTML, /styles\.css\?v=20260813-structured-fact-menus-v131/);
assert.match(serviceWorker, /permitext-pro-shell-v681/);
assert.match(workspaceScript, /paneID\?\.startsWith\("research:conversation:"\)/);
assert.match(serviceWorker, /styles\.css\?v=20260813-structured-fact-menus-v131/);
