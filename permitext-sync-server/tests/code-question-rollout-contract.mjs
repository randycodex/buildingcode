...
assert.match(workspaceHTML, /styles\.css\?v=20260812-notebook-header-gap-v57/);
assert.match(serviceWorker, /permitext-pro-shell-v638/);
assert.match(workspaceScript, /paneID\?\.startsWith\("research:conversation:"\)/);
assert.match(serviceWorker, /styles\.css\?v=20260812-notebook-header-gap-v57/);
