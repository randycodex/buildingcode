...
assert.match(workspaceHTML, /styles\.css\?v=20260811-evidence-reviewed-collapse-v1/);
assert.match(serviceWorker, /permitext-pro-shell-v610/);
assert.match(workspaceScript, /paneID\?\.startsWith\("research:conversation:"\)/);
assert.match(serviceWorker, /styles\.css\?v=20260811-evidence-reviewed-collapse-v1/);
