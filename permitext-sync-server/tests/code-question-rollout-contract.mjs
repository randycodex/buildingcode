...
assert.match(workspaceHTML, /styles\.css\?v=20260811-research-composer-heading-v1/);
assert.match(serviceWorker, /permitext-pro-shell-v606/);
assert.match(workspaceScript, /paneID\?\.startsWith\("research:conversation:"\)/);
assert.match(serviceWorker, /styles\.css\?v=20260811-research-composer-heading-v1/);
