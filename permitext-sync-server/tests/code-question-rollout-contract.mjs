...
assert.match(workspaceHTML, /styles\.css\?v=20260813-building-zoning-facts-v130/);
assert.match(serviceWorker, /permitext-pro-shell-v680/);
assert.match(workspaceScript, /paneID\?\.startsWith\("research:conversation:"\)/);
assert.match(serviceWorker, /styles\.css\?v=20260813-building-zoning-facts-v130/);
