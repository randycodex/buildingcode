...
assert.match(workspaceHTML, /styles\.css\?v=20260811-firm-collaboration-hidden-v2/);
assert.match(serviceWorker, /permitext-pro-shell-v596/);
assert.match(workspaceScript, /paneID\?\.startsWith\("research:conversation:"\)/);
assert.match(serviceWorker, /styles\.css\?v=20260811-firm-collaboration-hidden-v2/);
