...
assert.match(workspaceHTML, /styles\.css\?v=20260812-project-tools-equal-v42/);
assert.match(serviceWorker, /permitext-pro-shell-v623/);
assert.match(workspaceScript, /paneID\?\.startsWith\("research:conversation:"\)/);
assert.match(serviceWorker, /styles\.css\?v=20260812-project-tools-equal-v42/);
