...
assert.match(workspaceHTML, /styles\.css\?v=20260809-decision-index-width-v5/);
assert.match(serviceWorker, /permitext-pro-shell-v539/);
assert.match(serviceWorker, /styles\.css\?v=20260809-decision-index-width-v5/);
