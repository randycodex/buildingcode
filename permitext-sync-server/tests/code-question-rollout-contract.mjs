...
assert.match(workspaceHTML, /styles\.css\?v=20260812-report-template-menu-v62/);
assert.match(serviceWorker, /permitext-pro-shell-v643/);
assert.match(workspaceScript, /paneID\?\.startsWith\("research:conversation:"\)/);
assert.match(serviceWorker, /styles\.css\?v=20260812-report-template-menu-v62/);
