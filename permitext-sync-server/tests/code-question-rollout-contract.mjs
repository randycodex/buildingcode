...
assert.match(workspaceHTML, /styles\.css\?v=20260813-manual-structured-facts-v129/);
assert.match(serviceWorker, /permitext-pro-shell-v679/);
assert.match(workspaceScript, /paneID\?\.startsWith\("research:conversation:"\)/);
assert.match(serviceWorker, /styles\.css\?v=20260813-manual-structured-facts-v129/);
