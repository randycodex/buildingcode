...
assert.match(workspaceHTML, /styles\.css\?v=20260814-reader-nav-toggle-v133/);
assert.match(serviceWorker, /permitext-pro-shell-v683/);
assert.match(workspaceScript, /paneID\?\.startsWith\("research:conversation:"\)/);
assert.match(serviceWorker, /styles\.css\?v=20260814-reader-nav-toggle-v133/);
