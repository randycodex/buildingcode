...
assert.match(workspaceHTML, /styles\.css\?v=20260811-research-clear-v2/);
assert.match(serviceWorker, /permitext-pro-shell-v571/);
assert.match(serviceWorker, /styles\.css\?v=20260811-research-clear-v2/);
