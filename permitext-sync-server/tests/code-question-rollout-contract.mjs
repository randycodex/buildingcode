...
assert.match(workspaceHTML, /styles\.css\?v=20260809-project-selection-actions-v1/);
assert.match(serviceWorker, /permitext-pro-shell-v558/);
assert.match(serviceWorker, /styles\.css\?v=20260809-project-selection-actions-v1/);
