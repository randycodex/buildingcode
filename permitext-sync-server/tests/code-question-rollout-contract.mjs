...
assert.match(workspaceHTML, /styles\.css\?v=20260808-sync-conflict-review-v4/);
assert.match(serviceWorker, /permitext-pro-shell-v467/);
assert.match(serviceWorker, /styles\.css\?v=20260808-sync-conflict-review-v4/);
