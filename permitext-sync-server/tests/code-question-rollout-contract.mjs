...
assert.match(workspaceHTML, /styles\.css\?v=20260811-project-selection-layout-v1/);
assert.match(serviceWorker, /permitext-pro-shell-v614/);
assert.match(workspaceScript, /paneID\?\.startsWith\("research:conversation:"\)/);
assert.match(serviceWorker, /styles\.css\?v=20260811-project-selection-layout-v1/);
