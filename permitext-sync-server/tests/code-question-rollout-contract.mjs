...
assert.match(workspaceHTML, /styles\.css\?v=20260811-research-group-heading-v1/);
assert.match(serviceWorker, /permitext-pro-shell-v601/);
assert.match(workspaceScript, /paneID\?\.startsWith\("research:conversation:"\)/);
assert.match(serviceWorker, /styles\.css\?v=20260811-research-group-heading-v1/);
