...
assert.match(workspaceHTML, /styles\.css\?v=20260814-code-figure-rendering-v135/);
assert.match(serviceWorker, /permitext-pro-shell-v685/);
assert.match(workspaceScript, /paneID\?\.startsWith\("research:conversation:"\)/);
assert.match(serviceWorker, /styles\.css\?v=20260814-code-figure-rendering-v135/);
