...
assert.match(workspaceHTML, /styles\.css\?v=20260816-reader-orphan-cleanup-v342/);
assert.match(serviceWorker, /permitext-pro-shell-v699/);
assert.match(workspaceScript, /paneID\?\.startsWith\("research:conversation:"\)/);
assert.match(serviceWorker, /styles\.css\?v=20260816-reader-orphan-cleanup-v342/);
