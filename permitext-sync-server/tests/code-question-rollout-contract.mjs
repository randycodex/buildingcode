...
assert.match(workspaceHTML, /styles\.css\?v=20260812-report-width-v54/);
assert.match(serviceWorker, /permitext-pro-shell-v635/);
assert.match(workspaceScript, /paneID\?\.startsWith\("research:conversation:"\)/);
assert.match(serviceWorker, /styles\.css\?v=20260812-report-width-v54/);
