...
assert.deepEqual((await readdir(resultsPath)).sort(), resultsBefore,
  "A locked or malformed v14 attempt created a result file.");
...
console.log(
  "Zoning remediation-successor-3 v14 confirmation authorization contract passed; locked scope, consumed v13 lineage, hostile-runtime scrubbing, paid-dispatch blocks, and 30/30 no-cost preflight remain intact."
);
