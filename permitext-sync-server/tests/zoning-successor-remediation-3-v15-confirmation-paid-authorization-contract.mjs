...
assert.deepEqual((await readdir(resultsPath)).sort(), resultsBefore,
  "A locked or malformed v15 attempt created a result file.");
...
console.log(
  "Zoning remediation-successor-3 v15 confirmation authorization contract passed; locked scope, consumed v14 lineage, hostile-runtime scrubbing, paid-dispatch blocks, and 30/30 no-cost preflight remain intact."
);
