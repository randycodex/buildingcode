...
<button id="switch">Switch to conversation B</button><button id="move">Move pending conversation to B</button>
...
<div id="composer"><section id="research-dialogue-conversation-a"></section><label>Current draft<textarea class="research-question-input" aria-label="Current draft"></textarea></label><button class="research-send-button" disabled>Send</button><p class="research-composer-status"></p></div>
