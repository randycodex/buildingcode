...
const authenticatedConfirmation = zoningRemediationSuccessor3V16ConfirmationMode
  ? {
      version: "v16",
      validate:
        validateZoningRemediationSuccessor3V16ConfirmationPaidAuthorization,
