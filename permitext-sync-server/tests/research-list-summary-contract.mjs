...
assert.match(clientSource, /function unassignedSavedEvidenceKeys\(savedItems, projectSections\)[\s\S]*?!linkedSectionIDs\.has\(sectionID\)/, "Unassigned Saved does not derive its count from canonical evidence without a destination.");
