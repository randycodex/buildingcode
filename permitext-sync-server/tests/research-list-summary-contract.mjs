...
assert.match(clientSource, /refreshProjectSourceConsumers\(\[previousProjectID, targetProjectID\][\s\S]*?refreshNotebookFoundation: true/g, "Moving Research must invalidate both its old and new Project source consumers.");
