...
assert(shellPrecacheURLs.includes("/web/styles.css?v=20260811-research-composer-v2"));
...
assert.ok(deletedCacheNames.some((name) => name.startsWith("permitext-pro-shell-") && name !== "permitext-pro-shell-v584"));
