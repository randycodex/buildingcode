...
assert(shellPrecacheURLs.includes("/") && shellPrecacheURLs.includes("/web/app.js?v=20260817-native-research-notebook-v346"));
assert(shellPrecacheURLs.includes("/web/project-artifact-checkpoints.js?v=20260816-project-artifact-checkpoints-v2"));
assert(shellPrecacheURLs.includes("/web/styles.css?v=20260817-native-research-notebook-v346"));
