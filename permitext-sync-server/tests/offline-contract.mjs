...
assert(shellPrecacheURLs.includes("/") && shellPrecacheURLs.includes("/web/app.js?v=20260814-reader-nav-filter-v134"));
assert(shellPrecacheURLs.includes("/web/styles.css?v=20260814-reader-nav-filter-v134"));
