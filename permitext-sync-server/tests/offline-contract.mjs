...
assert(shellPrecacheURLs.includes("/") && shellPrecacheURLs.includes("/web/app.js?v=20260816-performance-pass-v334"));
assert(shellPrecacheURLs.includes("/web/styles.css?v=20260816-performance-pass-v334"));
