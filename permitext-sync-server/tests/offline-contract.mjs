...
assert(shellPrecacheURLs.includes("/") && shellPrecacheURLs.includes("/web/app.js?v=20260815-settings-radius-v255"));
assert(shellPrecacheURLs.includes("/web/styles.css?v=20260815-settings-radius-v255"));
