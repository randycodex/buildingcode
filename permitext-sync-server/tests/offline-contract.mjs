...
assert(shellPrecacheURLs.includes("/") && shellPrecacheURLs.includes("/web/app.js?v=20260817-research-multicorpus-v349"));
assert(shellPrecacheURLs.includes("/web/project-artifact-checkpoints.js?v=20260817-research-live-sync-v3"));
assert(shellPrecacheURLs.includes("/web/styles.css?v=20260817-research-multicorpus-v349"));
