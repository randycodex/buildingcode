...
assert(shellPrecacheURLs.includes("/") && shellPrecacheURLs.includes("/web/app.js?v=20260813-recent-preview-hydration-v132"));
assert(shellPrecacheURLs.includes("/web/styles.css?v=20260813-recent-preview-hydration-v132"));
