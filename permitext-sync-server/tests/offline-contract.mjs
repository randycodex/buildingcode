...
assert(shellPrecacheURLs.includes("/") && shellPrecacheURLs.includes("/web/app.js?v=20260809-project-research-entry-v3"));
assert(shellPrecacheURLs.includes("/web/styles.css?v=20260809-flat-evidence-candidates-v1"));
...
assert.ok(deletedCacheNames.some((name) => name.startsWith("permitext-pro-shell-") && name !== "permitext-pro-shell-v507"));
