...
assert(shellPrecacheURLs.includes("/") && shellPrecacheURLs.includes("/web/app.js?v=20260816-reader-static-text-v295"));
assert(shellPrecacheURLs.includes("/web/styles.css?v=20260816-reader-static-text-v295"));
