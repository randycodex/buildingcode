...
assert(shellPrecacheURLs.includes("/web/styles.css?v=20260811-search-history-height-v1"));
...
assert.ok(deletedCacheNames.some((name) => name.startsWith("permitext-pro-shell-") && name !== "permitext-pro-shell-v590"));
