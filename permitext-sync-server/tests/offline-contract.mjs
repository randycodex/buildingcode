...
assert(shellPrecacheURLs.includes("/") && shellPrecacheURLs.includes("/web/app.js?v=20260820-ux-alignment-phase1-v2"));
assert(shellPrecacheURLs.includes("/web/project-artifact-checkpoints.js?v=20260817-research-live-sync-v3"));
assert(shellPrecacheURLs.includes("/web/styles.css?v=20260820-ux-alignment-phase1-v2"));
