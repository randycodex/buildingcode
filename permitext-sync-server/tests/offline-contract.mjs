...
assert(shellPrecacheURLs.includes("/") && shellPrecacheURLs.includes("/web/app.js?v=20260813-code-basis-type-v119"));
assert(shellPrecacheURLs.includes("/web/styles.css?v=20260813-code-basis-type-v118"));
assert(shellPrecacheURLs.includes("/web/research-progress.js?v=20260813-code-basis-type-v118"));
