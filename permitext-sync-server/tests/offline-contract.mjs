...
assert(shellPrecacheURLs.includes("/") && shellPrecacheURLs.includes("/web/app.js?v=20260815-topbar-workspace-actions-v261"));
assert(shellPrecacheURLs.includes("/web/styles.css?v=20260815-topbar-workspace-actions-v261"));
