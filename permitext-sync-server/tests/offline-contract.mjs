...
assert(shellPrecacheURLs.includes("/") && shellPrecacheURLs.includes("/web/app.js?v=20260811-project-select-all-v1"));
assert(shellPrecacheURLs.includes("/web/styles.css?v=20260811-project-select-all-v1"));
...
assert.ok(deletedCacheNames.some((name) => name.startsWith("permitext-pro-shell-") && name !== "permitext-pro-shell-v613"));
