...
assert(shellPrecacheURLs.includes("/") && shellPrecacheURLs.includes("/web/app.js?v=20260815-research-delete-action-v252"));
assert(shellPrecacheURLs.includes("/web/styles.css?v=20260815-research-delete-action-v252"));
