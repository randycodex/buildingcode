...
assert(shellPrecacheURLs.includes("/") && shellPrecacheURLs.includes("/web/app.js?v=20260813-open-source-link-v107"));
assert(shellPrecacheURLs.includes("/web/styles.css?v=20260813-open-source-link-v106"));
assert(shellPrecacheURLs.includes("/web/research-progress.js?v=20260813-open-source-link-v106"));
