...
assert(shellPrecacheURLs.includes("/") && shellPrecacheURLs.includes("/web/app.js?v=20260812-release-surface-v39"));
assert(shellPrecacheURLs.includes("/web/styles.css?v=20260812-release-surface-v39"));
assert(shellPrecacheURLs.includes("/web/research-progress.js?v=20260812-release-surface-v39"));
...
assert.ok(deletedCacheNames.some((name) => name.startsWith("permitext-pro-shell-") && name !== "permitext-pro-shell-v620"));
