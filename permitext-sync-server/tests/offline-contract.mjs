...
assert(shellPrecacheURLs.includes("/") && shellPrecacheURLs.includes("/web/app.js?v=20260815-note-role-cleanup-v250"));
assert(shellPrecacheURLs.includes("/web/styles.css?v=20260815-note-role-cleanup-v250"));
