...
assert(shellPrecacheURLs.includes("/") && shellPrecacheURLs.includes("/web/app.js?v=20260815-notebook-size-order-v243"));
assert(shellPrecacheURLs.includes("/web/styles.css?v=20260815-notebook-size-order-v243"));
