...
assert(shellPrecacheURLs.includes("/") && shellPrecacheURLs.includes("/web/app.js?v=20260812-report-project-facts-v85"));
assert(shellPrecacheURLs.includes("/web/styles.css?v=20260812-report-project-facts-v85"));
assert(shellPrecacheURLs.includes("/web/research-progress.js?v=20260812-report-project-facts-v85"));
