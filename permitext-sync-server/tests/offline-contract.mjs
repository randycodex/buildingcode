...
assert(shellPrecacheURLs.includes("/") && shellPrecacheURLs.includes("/web/app.js?v=20260816-topbar-workspace-menu-v280"));
assert(shellPrecacheURLs.includes("/web/styles.css?v=20260816-topbar-workspace-menu-v280"));
