...
assert(shellPrecacheURLs.includes("/") && shellPrecacheURLs.includes("/web/app.js?v=20260816-saved-action-pills-v285"));
assert(shellPrecacheURLs.includes("/web/styles.css?v=20260816-saved-action-pills-v285"));
