...
assert(shellPrecacheURLs.includes("/") && shellPrecacheURLs.includes("/web/app.js?v=20260813-structured-fact-menus-v131"));
assert(shellPrecacheURLs.includes("/web/styles.css?v=20260813-structured-fact-menus-v131"));
