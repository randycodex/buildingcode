...
assert(shellPrecacheURLs.includes("/") && shellPrecacheURLs.includes("/web/app.js?v=20260816-notebook-writing-surface-v276"));
assert(shellPrecacheURLs.includes("/web/styles.css?v=20260816-notebook-writing-surface-v276"));
