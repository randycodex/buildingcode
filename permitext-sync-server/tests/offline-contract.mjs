...
assert(shellPrecacheURLs.includes("/") && shellPrecacheURLs.includes("/web/app.js?v=20260809-conversational-answer-v1"));
assert(shellPrecacheURLs.includes("/web/styles.css?v=20260809-conversational-answer-v1"));
assert(shellPrecacheURLs.includes("/web/client-reliability.js?v=20260809-session-stability-v1"));
assert(shellPrecacheURLs.includes("/web/workspace-state.js?v=20260809-conversational-answer-v1"));
assert(shellPrecacheURLs.includes("/web/code-question-workspace.js?v=20260809-context-bar-visibility-v3"));
...
assert.ok(deletedCacheNames.some((name) => name.startsWith("permitext-pro-shell-") && name !== "permitext-pro-shell-v533"));
