...
assert(shellPrecacheURLs.includes("/") && shellPrecacheURLs.includes("/web/app.js?v=20260812-research-progress-v13"));
assert(shellPrecacheURLs.includes("/web/styles.css?v=20260812-research-progress-v13"));
assert(shellPrecacheURLs.includes("/web/research-progress.js?v=20260812-research-progress-v13"));
