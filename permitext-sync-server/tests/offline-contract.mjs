...
assert(shellPrecacheURLs.includes("/") && shellPrecacheURLs.includes("/web/app.js?v=20260821-first-use-phase5-v1"));
assert(shellPrecacheURLs.includes("/web/project-artifact-checkpoints.js?v=20260817-research-live-sync-v3"));
assert(shellPrecacheURLs.includes("/web/styles.css?v=20260821-first-use-phase5-v1"));
assert(shellPrecacheURLs.includes("/web/research-intent-state.js?v=20260821-first-use-phase5-v1"));
