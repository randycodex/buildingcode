...
assert(shellPrecacheURLs.includes("/") && shellPrecacheURLs.includes("/web/app.js?v=20260811-recently-viewed-spacing-v2"));
assert(shellPrecacheURLs.includes("/web/styles.css?v=20260811-recently-viewed-spacing-v2"));
...
assert.ok(deletedCacheNames.some((name) => name.startsWith("permitext-pro-shell-") && name !== "permitext-pro-shell-v600"));
