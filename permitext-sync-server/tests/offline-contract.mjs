...
assert(shellPrecacheURLs.includes("/") && shellPrecacheURLs.includes("/web/app.js?v=20260816-clean-research-composer-v310"));
assert(shellPrecacheURLs.includes("/web/styles.css?v=20260816-clean-research-composer-v310"));
