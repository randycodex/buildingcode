...
assert(shellPrecacheURLs.includes("/") && shellPrecacheURLs.includes("/web/app.js?v=20260816-project-tool-transfer-v333"));
assert(shellPrecacheURLs.includes("/web/styles.css?v=20260816-project-tool-transfer-v333"));
