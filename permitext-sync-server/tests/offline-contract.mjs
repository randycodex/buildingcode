...
assert(shellPrecacheURLs.includes("/") && shellPrecacheURLs.includes("/web/app.js?v=20260815-settings-card-gap-v254"));
assert(shellPrecacheURLs.includes("/web/styles.css?v=20260815-settings-card-gap-v254"));
