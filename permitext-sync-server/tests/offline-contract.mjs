...
assert(shellPrecacheURLs.includes("/web/styles.css?v=20260809-saved-like-candidates-v1"));
...
assert.ok(deletedCacheNames.some((name) => name.startsWith("permitext-pro-shell-") && name !== "permitext-pro-shell-v508"));
