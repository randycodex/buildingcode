...
assert(shellPrecacheURLs.includes("/") && shellPrecacheURLs.includes("/web/app.js?v=20260813-research-status-type-v117"));
assert(shellPrecacheURLs.includes("/web/styles.css?v=20260813-research-status-type-v116"));
assert(shellPrecacheURLs.includes("/web/research-progress.js?v=20260813-research-status-type-v116"));
