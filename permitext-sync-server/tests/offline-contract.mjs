...
assert(shellPrecacheURLs.includes("/") && shellPrecacheURLs.includes("/web/app.js?v=20260815-progress-cancel-v251"));
assert(shellPrecacheURLs.includes("/web/styles.css?v=20260815-progress-cancel-v251"));
