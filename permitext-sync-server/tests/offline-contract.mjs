...
assert(shellPrecacheURLs.includes("/") && shellPrecacheURLs.includes("/web/app.js?v=20260809-session-stability-v2"));
...
assert(shellPrecacheURLs.includes("/web/code-question-client-state.js?v=20260809-session-stability-v2"));
...
assert.ok(deletedCacheNames.some((name) => name.startsWith("permitext-pro-shell-") && name !== "permitext-pro-shell-v480"));
