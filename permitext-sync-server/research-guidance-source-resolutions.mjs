...
export const guidanceSourceResolutionDraftInstruction = [
  ...
  "Resolved means the supplied sources and facts establish a consistent applicable direction. Merely restating competing directions is not a resolution. If their relationship remains unknown, select unresolved and name the exact action or condition that still needs confirmation in the statement.",
