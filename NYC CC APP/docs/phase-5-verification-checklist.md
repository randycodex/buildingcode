...
11. For cross-device entitlement verification, point both clients at a non-production backend and use App Store Sandbox or TestFlight. Xcode-local transactions are device-only, and no test transaction may create a production web entitlement.
