...
- [ ] Complete Apple-created Sandbox and TestFlight subscription lifecycle evidence against the compatible staging backend. Purchase, no-charge confirmation, local Pro/100-turn activation, account ownership, Restore, failed-delivery retry, post-cancellation notification delivery, cancellation-period access retention, canceled-period expiration, refund submission, refund revocation, renewal, billing failure/recovery, and build 48 Sandbox identity continuity pass; duplicate delivery and delayed delivery remain open.
