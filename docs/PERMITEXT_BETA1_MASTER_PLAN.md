...
| Zoning Research Beta 1 expansion | Locked v11 package reviewed; paid confirmation not authorized; semantic, reliability, and cost gates open | The first exact remediation-3 run spent `$0.287113`, completed 2/30 operations with both passing at 4.00/4, then failed closed at the Appendix J case. The [post-v8 confirmation](./PERMITEXT_ZONING_REMEDIATION_3_V8_CONFIRMATION_RESULT_2026-08-30.md) spent `$0.297314` and repeated that outcome. The independently reviewed v9 repair retained privacy-bounded diagnostics and matched safe/unsafe regressions; after a `$0` pre-dispatch package-buffer stop, exact replacement package `571367800030d49a103a999090eaa615baa361ec` ran once under a separate authorization. Its [terminal result](./PERMITEXT_ZONING_REMEDIATION_3_V9_CONFIRMATION_RESULT_2026-08-31.md) spent `$0.299904`, again passed the first two cases at 4.00/4, and failed closed at case three. No-cost v10 diagnosis reproduced the retained shape, but independent mutation review rejected v10 before packaging. V11 replaces the broad matching with anchored generic-source/evidence forms, field-level default deny, cross-clause actor and subject-ellipsis state, and structural boundary-mask detection. Distinct package `8d075b442083db3536de0ff9e90372802ddeadaa` is now locked and independently reviewed; its signed one-time runner handoff, exact package/input hashes, runtime pinning, focused tests, 30/30 mock preflight, and complete repository check pass with zero paid calls. Authorization remains null and inactive. This prospective package does not identify or rescore the unavailable v9 answer. All three earlier authorizations are consumed; 27 cases and both changed successor cases remain unattempted. The `$13.04`, `$13.40`, and `$13.44` two-turn projections are not sample-ready, so remediation 2's `$20.18` per-100 all-Zoning risk projection and `$20.72` 100%-Zoning mixed-month p90 remain controlling. Cases 1, 3, and 11 remain held. Public Zoning Research stays disabled. |
...
- [ ] Only after a fresh exact owner authorization for package `8d075b442083db3536de0ff9e90372802ddeadaa`, run all 30 ordered remediation-successor-3 cases once under the `$5` cumulative cap; require a clean complete semantic result before resolving reliability/cost acceptance or any enablement decision. The [first remediation-3 result](./PERMITEXT_ZONING_REMEDIATION_3_SEMANTIC_RESULT_2026-08-30.md), [post-v8 confirmation](./PERMITEXT_ZONING_REMEDIATION_3_V8_CONFIRMATION_RESULT_2026-08-30.md), and [v9 confirmation](./PERMITEXT_ZONING_REMEDIATION_3_V9_CONFIRMATION_RESULT_2026-08-31.md) are not sample-ready; the [remediation-2 result](./PERMITEXT_ZONING_REMEDIATION_2_SEMANTIC_RESULT_2026-08-30.md) keeps the `$20.18` failed-work-amortized 100-turn projection controlling. No paid run is currently authorized.
