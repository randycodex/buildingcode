...
| Zoning Research Beta 1 expansion | Owner-approved successor passes no-cost gate; clean semantic run not authorized | The complete corpus and no-cost safety contracts pass. The latest $5-capped frozen diagnostic spent $3.247980, completed 28/30 production turns without charging the two failures, and passed 12/28 graded answers. Four pipeline/evaluator defects and the generic mapped-location, transition-history, definition, date-path, arithmetic, and stated-scenario completeness gaps are repaired under no-cost contracts. The owner approved two corrected answer keys and six exact scope dispositions; the separately frozen 30-case successor preserves all questions, evidence pins, and forbidden claims and passes 30/30 no-cost checks. Cases 1, 3, and 11 remain held. The expanded cost projection is $8.87 per 100 all-Zoning turns and 100% Zoning p90 is $9.33. The retained 24,000-character supplemental candidate preserves all 87 exact selections and eight structured sources and averages 34,821 assembled characters, but remains disabled. A newly authorized clean semantic run and web/iOS acceptance remain. Public Zoning Research stays disabled. |
