...
- [ ] Resolve the successor's three execution failures and nine graded fatal-gate failures, reduce cost, and confirm the repaired cohort in a newly authorized clean semantic run before enablement.
