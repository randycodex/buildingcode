...
| Billing and paid continuation | Partially complete | Server billing contracts, local Stripe/Apple exercises, the provider-backed Stripe sandbox lifecycle, isolated Apple staging, and physical-iPhone purchase/account-restore/retry/cancellation-retention/expiration evidence through build 44 pass. Build 45 exposed a physical refund-sheet presentation defect; build 46 contains the tested direct-StoreKit replacement and is processing in App Store Connect. Refund acceptance and the remaining Apple lifecycle cases, controlled Production billing, and final serving-release verification remain. Additional-turn sales stay disabled. |
