...
Checklist snapshot: **110 completed, 14 open**, plus a separately tracked 11-step final merge, deployment, TestFlight, and release sequence. Those 11 substeps are not included in the 14 main open-checkbox count and have not been authorized on this branch.
...
- [x] Complete the post-v9 no-cost diagnosis and prospective v10 repair: reproduce the retained boundary-present/direct-conclusion shape with safe source-level wording, accept only six explicit generic-source forms, keep six paired site/project/property conclusions fail-closed, preserve consumed v9 evidence against its historical committed bytes, and pass the 30/30 mock preflight with credentials unset and zero paid calls.
- [ ] Resolve the remaining unconfirmed remediation-successor-2 paths/outcomes, reduce and accept cost, and confirm all 30 remediation-successor-3 cases in a newly authorized clean semantic run before enablement. The [first remediation-3 result](./PERMITEXT_ZONING_REMEDIATION_3_SEMANTIC_RESULT_2026-08-30.md), [post-v8 confirmation](./PERMITEXT_ZONING_REMEDIATION_3_V8_CONFIRMATION_RESULT_2026-08-30.md), and [v9 confirmation](./PERMITEXT_ZONING_REMEDIATION_3_V9_CONFIRMATION_RESULT_2026-08-31.md) are not sample-ready; the [remediation-2 result](./PERMITEXT_ZONING_REMEDIATION_2_SEMANTIC_RESULT_2026-08-30.md) keeps the `$20.18` failed-work-amortized 100-turn projection controlling. No new paid run is authorized; any later paid confirmation requires a distinct locked package, an exact owner authorization for all 30 ordered cases and one repetition, and a new cumulative cap no higher than `$5`.
