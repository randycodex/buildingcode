...
| Zoning Research Beta 1 expansion | Remediation-2 no-cost ready; semantic, reliability, and cost gates open | The historical owner-approved successor and its one authorized run remain unchanged: $3.333192 spent, 27/30 production turns completed, three failed without a user charge, and 18/27 graded answers passed. Its current deterministic preflight remains 27/30. The three later owner-approved source-bound corrections exist only in a separately frozen remediation-2 successor, which passes 30/30 no-cost canonical-evidence and conversation-creation checks. Its complete disabled 24,000-character prototype preserves all 87 exact pinned sources and eight structured sources, averaging 28,712 assembled characters. [No-cost execution-path readiness](./PERMITEXT_ZONING_REMEDIATION_2_EXECUTION_PATH_READINESS_2026-08-30.md) now covers the exact City repair, MIH safe/unsafe counterexamples, privacy-safe office structured-attempt diagnostics, and a separate exact-SHA paid guard and runner that remain locked without a new owner decision. No new semantic or cost result exists. Historical failed-work-amortized cost remains $10.01 per 100 all-Zoning turns; mixed-month p90 remains $10.41 at 100% Zoning, with negative $0.19 web and negative $2.21 iOS contribution under current reserves. Every prior authorization is consumed or inapplicable. Cases 1, 3, and 11 remain held. A dedicated fail-closed public-release gate still requires a clean newly authorized semantic result, accepted cost and reliability, and exact-release web/TestFlight physical-iPhone acceptance. Public Zoning Research stays disabled. |
...
- [ ] Resolve against remediation successor 2 the three execution-failure paths and nine graded fatal-gate failure paths exposed by the historical first-successor run, reduce and accept cost, and confirm the repaired cohort in a newly authorized clean semantic run before enablement. The [no-cost failure triage](./PERMITEXT_ZONING_SUCCESSOR_FAILURE_TRIAGE_2026-08-30.md) separates evaluator defects, product-completeness defects covered by safeguards, the three now-corrected answer-key/evidence blockers, and the three execution paths. The separately frozen remediation-2 successor passes deterministic preflight at 30/30, but semantic, reliability, cost, and exact-release acceptance remain open. Any paid confirmation requires a new explicit one-run authorization and cumulative cap.
...
- the three execution-failure paths, nine graded quality-failure paths, and above-target cost exposed by the historical first-successor run are repaired or cleanly resolved against remediation successor 2, and a newly authorized clean semantic run plus exact-release web/TestFlight physical-iPhone acceptance passes;
