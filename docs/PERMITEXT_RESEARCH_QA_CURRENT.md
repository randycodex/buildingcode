...
1. **High — Supplied-document breadth and continuation.** The explicit quoted-clause case now passes with real models, direct interpretation, independent verification and reload persistence. Broader phrasing, later follow-ups and mixed code/document requests still need tests. Simple missing-document clarification still spends unnecessary calls. Keep pasted text distinct from enacted authority.
