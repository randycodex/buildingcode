...
- Prevent the fixed page body and outer Research panel from scrolling internally; header/composer remain fixed while the message thread scrolls.
- Show two-line saved-passage previews under citation links; verify Reader navigation from a preview row.
...
Current accounting: approximately $6.07 provider estimate; $13.31 conservative session accounting against the $17 cap. Both unsuccessful and successful calls are retained in the detailed record.
