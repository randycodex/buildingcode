...
This does not close the manual release gate. The audit reports `configurationReady: true`, `manualAcceptanceComplete: false`, and `releaseReady: false` until fresh and existing email/Apple/Google/Microsoft sign-in and one dedicated account export/deletion lifecycle are explicitly evidenced after the final deployment. Full evidence: [PERMITEXT_PRODUCTION_AUTH_CONFIGURATION_EVIDENCE_2026-08-29.md](./PERMITEXT_PRODUCTION_AUTH_CONFIGURATION_EVIDENCE_2026-08-29.md).
