...
The expanded run produced four no-cost pipeline/evaluator repairs and identified two invalid answer keys. The product correctly refused to invent an unsupported UAP increment rule in expanded Case 22 and correctly applied the R7A-specific through-lot provision in expanded Case 23. Those keys remain frozen pending owner disposition; Permitext will not be weakened merely to satisfy them. Evidence and proposed replacements: [PERMITEXT_ZONING_EXPANDED_SEMANTIC_RESULT_2026-08-30.md](./PERMITEXT_ZONING_EXPANDED_SEMANTIC_RESULT_2026-08-30.md) and [PERMITEXT_ZONING_BATCH1_RUBRIC_REVIEW_2026-08-30.md](./PERMITEXT_ZONING_BATCH1_RUBRIC_REVIEW_2026-08-30.md).

The six-case secondary rubric-scope audit is also complete with no data mutation and no provider call. It proposes removing collateral or duplicate requirements in five cases, while preserving the material 6.00 FAR, verified historical-text, and historical-map/lot omissions. The separately frozen successor must not be created until owner disposition. Evidence: [PERMITEXT_ZONING_EXPANDED_RUBRIC_SCOPE_AUDIT_2026-08-30.md](./PERMITEXT_ZONING_EXPANDED_RUBRIC_SCOPE_AUDIT_2026-08-30.md).
...
Obtain owner disposition on the two source-bound answer-key replacements and the prepared six-case scope dispositions, create a separately versioned successor only from approved changes, and then decide whether a clean semantic confirmation is justified. The retained 24,000-character supplemental candidate already passes the full current no-cost gate but remains disabled. Any later paid request requires a new explicit owner authorization and a new cumulative spend cap. Do not enable public Zoning Research.
