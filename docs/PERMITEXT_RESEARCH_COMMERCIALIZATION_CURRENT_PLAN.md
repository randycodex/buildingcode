...
The owner-approved successor is frozen from all eight dispositions. Its manifest binds the immutable 30-case parent and both review documents; its generator and contract preserve every question, selected evidence section, and forbidden safety claim. At freeze time all 30 cases passed canonical-evidence preflight and conversation creation. Stronger bare-section parsing plus the later official applicability audit expose three answer-key/evidence blockers without mutating that record, so current preflight now fails closed at 27/30. The earlier 24,000-character prototype preserved all 87 exact selected sources and eight structured sources, averaging 34,821 assembled characters. No provider call was made, the candidate remained disabled, and paid/public use remained locked. Evidence: [PERMITEXT_ZONING_OWNER_APPROVED_SUCCESSOR_2026-08-30.md](./PERMITEXT_ZONING_OWNER_APPROVED_SUCCESSOR_2026-08-30.md).

Paid-run preparation is fail-closed without mutating the frozen successor. A separate authorization record binds the exact successor SHA and is `consumed`; both the dedicated runner and direct live evaluation path refuse to reuse it. Any later run requires a new explicit owner decision and authorization record covering all 30 cases, one repetition, and a cumulative cap no higher than $5, while the 24,000-character candidate, deployment, public access, pricing, and allowance changes remain disabled. The direct-live bypass regression passes without a provider call.
...
The successor's complete [no-cost failure triage](./PERMITEXT_ZONING_SUCCESSOR_FAILURE_TRIAGE_2026-08-30.md) is now retained. Three scored failures were evaluator blind spots for independently reviewed structured evidence; five were genuine completeness misses now covered by Zoning safety regressions; and stronger extraction finds three frozen keys naming unselected ZR 101-70, 23-34, or 24-382. Current applicability text confirms that selected ZR 23-343 supplies Case 23's residential branch, while ZR 24-31 makes the omitted community-facility status a material fact in its frozen question. The three mismatches now block preflight at 27/30 and require coherent new owner dispositions before a corrected successor can be frozen. Zoning safety v4 now covers the City of Yes historical-text boundary and the full case-matched MIH path: confirmed mapped status is not re-requested, numerical thresholds alone cannot grant the exception, tax lots are not presumed to be the historical zoning lot, and official establishment-date and historical-lot evidence remain required. The office path now has privacy-safe structured-failure-stage telemetry and a concise bounded retry, but its frozen historical subcause is unrecoverable. Semantic confirmation remains open. The paid result was not rescored or changed.

The corrected [successor evidence-budget advisory](./PERMITEXT_ZONING_SUCCESSOR_EVIDENCE_BUDGET_ADVISORY_2026-08-30.md) completed without provider spend on the exact ordered 27 ready cases while leaving all three answer-key/evidence blockers outside the comparison. The disabled 24,000-character supplemental candidate reduced average stored, hash-bound passage text from 41,384 to 29,460 characters, or 28.8%, while preserving all 82 exact pinned sources, eight reviewed structured sources, and every required or answer-key-named Zoning section in the ready cohort. Stable identities show 16 baseline cross-reference sections absent and one candidate-only identity, a net reduction of 15; three of the 23 cross-reference sections retained under both budgets also have different passage hashes. Canonical context that is neither sent nor persisted no longer consumes the budget and is reported separately. Dataset, implementation-source, and ordered-package hashes bind the comparison, and bare, grouped, ranged, suffix, symbol, and Appendix ZR references are fail-closed. The differences keep semantic acceptance open. The full successor remains 27/30, the candidate remains disabled, and no cost, Production, pricing, allowance, or public-enable decision was made.
...
Obtain the owner's exact approval for three source-bound case corrections: narrowly rephrase the special-district and narrow-rear-yard concepts so they do not claim unselected ZR 101-70 or 23-34, and choose one coherent Case 23 scope recorded in [the applicability audit](./PERMITEXT_ZONING_CASE23_APPLICABILITY_AUDIT_2026-08-30.md); the recommended Case 23 option adds an explicit no-community-facility fact and uses the selected ZR 23-343 residential key. The ready-case evidence-budget advisory is complete, but the retained 24,000-character supplemental candidate stays disabled until a corrected successor and newly authorized clean semantic comparison confirm it. Freeze a new remediation successor only after those substantive case decisions; the office, City of Yes, and MIH execution paths remain eligible for a later semantic confirmation only under a new explicit one-run authorization and cumulative spend cap. Do not enable public Zoning Research.
