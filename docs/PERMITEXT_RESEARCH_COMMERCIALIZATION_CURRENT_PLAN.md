...
Diagnose and repair the successor's three execution failures and nine graded fatal-gate failures without weakening citation, missing-fact, evidence, or unofficial-aid boundaries. Reduce the evidence/model cost while keeping the retained 24,000-character supplemental candidate disabled until its complete no-cost and semantic gates pass. Any later paid run requires a new explicit owner authorization and cumulative spend cap; the consumed authorization cannot be reused. Do not enable public Zoning Research.
