...
Propose a written cap for the first frozen paid Zoning benchmark using the available API balance. Do not make an API call until the owner separately approves that exact cap, and do not enable public Zoning Research during this step.
