...
The expanded run produced four no-cost pipeline/evaluator repairs and identified two invalid answer keys. The product correctly refused to invent an unsupported UAP increment rule in expanded Case 22 and correctly applied the R7A-specific through-lot provision in expanded Case 23. The retained parent cohort and paid result remain frozen. The owner approved both source-bound replacement keys for a separately versioned successor; Permitext was not weakened merely to satisfy the old rubrics. Evidence and proposed replacements: [PERMITEXT_ZONING_EXPANDED_SEMANTIC_RESULT_2026-08-30.md](./PERMITEXT_ZONING_EXPANDED_SEMANTIC_RESULT_2026-08-30.md) and [PERMITEXT_ZONING_BATCH1_RUBRIC_REVIEW_2026-08-30.md](./PERMITEXT_ZONING_BATCH1_RUBRIC_REVIEW_2026-08-30.md).
...
The owner-approved successor is now frozen from all eight dispositions. Its manifest binds the immutable 30-case parent and both review documents; its generator and contract preserve every question, selected evidence section, and forbidden safety claim. All 30 cases pass canonical-evidence preflight and conversation creation. The retained 24,000-character supplemental candidate again preserves all 87 exact selected sources and eight structured sources, averaging 34,821 assembled characters. No provider call was made, the candidate remains disabled, and paid/public use remains locked. Evidence: [PERMITEXT_ZONING_OWNER_APPROVED_SUCCESSOR_2026-08-30.md](./PERMITEXT_ZONING_OWNER_APPROVED_SUCCESSOR_2026-08-30.md).

Paid-run preparation is now fail-closed without mutating the frozen successor. A separate authorization record binds the exact successor SHA and remains `locked`; both the dedicated runner and direct live evaluation path refuse to start without an explicit owner decision. The guard limits any later authorization to all 30 cases, one repetition, and a cumulative cap no higher than $5, while keeping the 24,000-character candidate, deployment, public access, pricing, and allowance changes disabled. The direct-live bypass regression passes without a provider call.
...
The successor's complete [no-cost failure triage](./PERMITEXT_ZONING_SUCCESSOR_FAILURE_TRIAGE_2026-08-30.md) is now retained. Three scored failures were evaluator blind spots for independently reviewed structured evidence; five were genuine completeness misses now covered by Zoning safety regressions; and the deep-through-lot key explicitly names unselected ZR 24-382 while the case selects current ZR 23-343. That mismatch now blocks preflight at 29/30 and requires a new owner disposition before another successor can be frozen. Zoning safety v4 now covers the City of Yes historical-text boundary and the full case-matched MIH path: confirmed mapped status is not re-requested, numerical thresholds alone cannot grant the exception, tax lots are not presumed to be the historical zoning lot, and official establishment-date and historical-lot evidence remain required. The office path now has privacy-safe structured-failure-stage telemetry and a concise bounded retry, but its frozen historical subcause is unrecoverable. Semantic confirmation remains open. The paid result was not rescored or changed.
...
Obtain the owner's source-bound disposition for the deep-through-lot answer key, then finish no-cost evidence/model-cost reduction with the retained 24,000-character supplemental candidate still disabled. Freeze a new remediation successor only after the substantive key decision; the office, City of Yes, and MIH execution paths remain eligible for a later semantic confirmation only under a new explicit one-run authorization and cumulative spend cap. Do not enable public Zoning Research.
