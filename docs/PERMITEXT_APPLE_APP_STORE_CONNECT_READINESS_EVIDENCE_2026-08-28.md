...
| Sandbox accounts | Two United States test accounts exist. The dedicated `permitext+storekit1@gmail.com` tester completed the no-charge physical-iPhone purchase and restore exercise described below. |
