...
| --- | --- | --- |
| Research | Web/native draft persistence implemented; context/layout contracts; native cache isolation tested; production new-chat draft reload, context disclosure and visible selection checkmark verified; Sep 16 live failed request and unsent follow-up survived reload/new tab | Live request failed enacted-evidence verification; successful-answer follow-up restoration and authenticated native lifecycle remain open |
