...
| P2-4 | Reader chrome inconsistently identifies edition. | Native/web edition labels and citation identity repairs are implemented. Production and physical saved-citation paths show correct 2014/2022 labels; the native 2022 header remains visible after scrolling beyond the target provision. | Complete broader source, scroll-position and assistive-technology coverage. |
