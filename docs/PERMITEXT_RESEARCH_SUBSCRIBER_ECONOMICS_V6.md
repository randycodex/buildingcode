...
For iOS, Apple documents the customer price as inclusive of applicable taxes it collects and remits, and Partner Share as customer price minus applicable taxes and commission. Stripe automatic tax therefore remains web-only. The 5% iOS reserve remains until the live app/subscription tax category and actual financial reports are verified. [Apple tax categories](https://developer.apple.com/help/app-store-connect/manage-app-information/set-a-tax-category) · [Apple financial report fields](https://developer.apple.com/help/app-store-connect/reference/reporting/financial-report-fields/)
