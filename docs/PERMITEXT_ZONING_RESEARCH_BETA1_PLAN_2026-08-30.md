...
7. **Paid validation — three diagnostics retained; quality gate not passed** — the first frozen 21-case run spent $1.857548 and passed 11/20 graded answers. The frozen 30-case expanded-parent run spent $3.247980, completed 28 operations, and passed 12/28 graded answers. After no-cost remediation and eight owner-approved answer-key/rubric dispositions, the exact 30-case first remediation successor spent $3.333192, completed 27 operations, failed three without a user charge, and passed 18/27 graded answers. Every authorization is consumed. Remediation successor 2 has not received a paid run. Any later run requires a new exact-dataset owner decision and cumulative cap.
8. **Batch 1 expansion — three case corrections complete; remediation successor 2 frozen and no-cost ready** — the original 21-case cohort, expanded 30-case cohort, first remediation successor, and retained paid results remain unchanged. Remediation successor 2 binds that lineage and the exact owner/applicability/triage records, changes only the three approved cases, and preserves every selected evidence ID and forbidden claim. It passes 30/30 no-cost canonical-evidence and conversation-creation checks. Source Cases 1, 3, and 11 remain held, paid evaluation is locked, and public Research remains disabled. Evidence: [PERMITEXT_ZONING_SUCCESSOR_REMEDIATION_2_2026-08-30.md](./PERMITEXT_ZONING_SUCCESSOR_REMEDIATION_2_2026-08-30.md).
9. **Economics — updated sensitivity and full-cohort no-cost candidate check complete; decision gate not passed** — the historical first-remediation-successor sample projects $10.01 per 100 all-Zoning turns after failed-work amortization. Mixed 100-turn provider p90 is $6.06 at 0% Zoning, $7.15 at 25%, $8.23 at 50%, and $10.41 at 100%. At 100% Zoning, modeled p90 contribution is negative $0.19 on web and negative $2.21 on iOS at 15%. The corrected 27/30 advisory reduced average stored hash-bound passage text from 41,384 to 29,460 characters at the disabled 24,000 supplemental candidate while preserving every deterministic required section. Remediation successor 2 extends the disabled-candidate check to all 30 cases: 30/30 ready; 28,712 average and 38,896 maximum assembled characters; 6,352 average pinned and 22,360 average supplemental characters; 87 exact pinned sources, eight structured sources, 117 discovered sources, and 29 cross-references. All selected sources were preserved with zero provider tokens or cost. This is not semantic or cost acceptance. The candidate remains disabled, and the $20 price and 100-turn allowance remain unchanged assumptions. Evidence: [PERMITEXT_ZONING_SUCCESSOR_REMEDIATION_2_2026-08-30.md](./PERMITEXT_ZONING_SUCCESSOR_REMEDIATION_2_2026-08-30.md).
   - Post-run [failure triage](./PERMITEXT_ZONING_SUCCESSOR_FAILURE_TRIAGE_2026-08-30.md) remains historical evidence for the first remediation successor, whose stronger deterministic preflight is 27/30. The owner-approved corrections for the special-district, narrow-rear-yard, and deep-through-lot keys are frozen only in remediation successor 2, which passes 30/30 no-cost preflight. Its [no-cost execution-path readiness](./PERMITEXT_ZONING_REMEDIATION_2_EXECUTION_PATH_READINESS_2026-08-30.md) now adds exact City repair coverage, MIH safe/unsafe counterexamples, and privacy-safe office attempt diagnostics without adding retries. No new semantic run exists; semantic quality, measured reliability, cost, and exact-release gates remain open.
