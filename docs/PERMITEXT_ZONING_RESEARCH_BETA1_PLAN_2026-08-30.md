...
7. **Paid validation — four diagnostics retained; quality gate not passed** — the first frozen 21-case run spent $1.857548 and passed 11/20 graded answers. The frozen 30-case expanded-parent run spent $3.247980, completed 28 operations, and passed 12/28 graded answers. The exact first remediation successor spent $3.333192, completed 27 operations, and passed 18/27 graded answers. Exact remediation successor 2 spent `$3.357895`, completed 15 operations, failed 15 without a user charge, and passed 13/15 graded answers. Every authorization is consumed. Any later run requires a new exact frozen successor, owner decision, and cumulative cap.
8. **Batch 1 expansion — remediation-successor-2 result retained; no-cost v7 review complete** — the original 21-case cohort, expanded 30-case cohort, first remediation successor, and retained paid results remain unchanged. Remediation successor 2 binds that lineage and preserves every selected evidence ID and forbidden claim. Post-run Zoning safety v7 includes the earlier false-positive trigger narrowing plus event-linked date relationships, cautious MIH with historically bound concrete records, clause-local mapped boundaries, cellar direct/supporting-claim consistency, weak special-parking evidence boundaries, and non-contradictory Zoning Lot tax-map distinctions. Independent review also found two frozen case/evidence defects requiring owner-approved successor changes. None of this alters or rescores the paid result. Five execution paths and two graded failures remain unconfirmed. Source Cases 1, 3, and 11 remain held, no later paid evaluation is authorized, and public Research remains disabled. Evidence: [PERMITEXT_ZONING_REMEDIATION_2_SEMANTIC_RESULT_2026-08-30.md](./PERMITEXT_ZONING_REMEDIATION_2_SEMANTIC_RESULT_2026-08-30.md).
9. **Economics — updated sensitivity and full-cohort no-cost candidate check complete; decision gate not passed** — the incomplete remediation-successor-2 sample projects `$20.18` per 100 all-Zoning turns after failed-work amortization. Mixed 100-turn provider p90 is `$6.06` at 0% Zoning, `$9.74` at 25%, `$13.40` at 50%, and `$20.72` at 100%. At 100% Zoning, modeled p90 contribution is negative `$10.50` on web and negative `$12.52` on iOS at 15%. The disabled 24,000-character candidate remains separate engineering evidence: 30/30 ready; 28,712 average and 38,896 maximum assembled characters; 6,352 average pinned and 22,360 average supplemental characters; 87 exact pinned sources, eight structured sources, 117 discovered sources, and 29 cross-references. All selected sources were preserved with zero provider tokens or cost. This incomplete sample is not pricing acceptance. The candidate remains disabled, and the $20 price and 100-turn allowance remain unchanged assumptions. Evidence: [PERMITEXT_ZONING_REMEDIATION_2_SEMANTIC_RESULT_2026-08-30.md](./PERMITEXT_ZONING_REMEDIATION_2_SEMANTIC_RESULT_2026-08-30.md).
