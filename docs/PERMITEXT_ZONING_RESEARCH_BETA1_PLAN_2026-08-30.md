...
- A separate immutable expanded cohort contains those unchanged 21 cases plus nine owner-approved Batch 1 cases. After its retained paid diagnostic exposed two invalid keys and six rubric-scope decisions, the owner approved all eight dispositions. A second separately frozen 30-case remediation successor contains only those approved changes and passed all 30 no-cost checks at freeze time. Stronger bare-section parsing now exposes two additional unselected answer-key references, and the later Case 23 applicability re-audit leaves current preflight fail-closed at 27/30. Source Cases 1, 3, and 11 remain held outside both cohorts.
...
7. **Paid validation — three diagnostics retained; quality gate not passed** — the first frozen 21-case run spent $1.857548 and passed 11/20 graded answers. The frozen 30-case expanded-parent run spent $3.247980, completed 28 operations, and passed 12/28 graded answers. After no-cost remediation and eight owner-approved answer-key/rubric dispositions, the exact 30-case remediation successor spent $3.333192, completed 27 operations, failed three without a user charge, and passed 18/27 graded answers. Every authorization is consumed. Any later run requires a new owner decision and cumulative cap.
8. **Batch 1 expansion — owner-approved remediation successor frozen; later case corrections open** — the original 21-case and expanded 30-case cohorts remain unchanged. A second separately frozen 30-case successor binds the parent and both review documents, applies only the eight owner-approved dispositions, and preserves every question, selected evidence section, and forbidden claim. It passed 30/30 no-cost canonical-evidence and conversation-creation checks when frozen. Stronger parsing now finds unselected ZR 101-70, 23-34, and 24-382 references in three frozen answer keys; current preflight correctly fails closed at 27/30 without mutating the successor. Source Cases 1, 3, and 11 remain held.
9. **Economics — updated sensitivity and successor ready-case advisory complete; decision gate not passed** — the remediation-successor sample projects $10.01 per 100 all-Zoning turns after failed-work amortization. Mixed 100-turn provider p90 is $6.06 at 0% Zoning, $7.15 at 25%, $8.23 at 50%, and $10.41 at 100%. At 100% Zoning, modeled p90 contribution is negative $0.19 on web and negative $2.21 on iOS at 15%. The earlier no-cost audit found 42,033 average assembled evidence characters versus 6,262 average reviewed exact-passage characters in the expanded parent. A three-budget prototype preserved all 87 exact selected sources and eight structured sources. The corrected 27/30 successor advisory compared identical ordered ready cases and reduced average stored, hash-bound passage text from 41,384 to 29,460 characters at the 24,000 supplemental candidate while preserving every deterministic required section; 16 baseline cross-reference identities were absent, one candidate-only identity appeared, and three retained cross-reference sections changed passage hashes. The 28.8% reduction excludes canonical context that was neither sent nor persisted. Exact dataset, implementation-source, and ordered-package hashes bind the comparison. The candidate remains disabled pending a corrected full successor and semantic confirmation. The $20 price and 100-turn allowance remain unchanged assumptions. Evidence: [PERMITEXT_ZONING_SUCCESSOR_EVIDENCE_BUDGET_ADVISORY_2026-08-30.md](./PERMITEXT_ZONING_SUCCESSOR_EVIDENCE_BUDGET_ADVISORY_2026-08-30.md).
   - Post-run [failure triage](./PERMITEXT_ZONING_SUCCESSOR_FAILURE_TRIAGE_2026-08-30.md) is complete without provider spend. The current successor fails preflight at 27/30 because the special-district, narrow-rear-yard, and deep-through-lot keys name unselected ZR 101-70, 23-34, and 24-382 respectively. The later [official-source applicability re-audit](./PERMITEXT_ZONING_CASE23_APPLICABILITY_AUDIT_2026-08-30.md) confirms selected ZR 23-343 as Case 23's residential branch but finds community-facility status unresolved in the frozen question; ZR 24-31 can make the Chapter 4 path material on a mixed-use lot. Three coherent owner dispositions are required before another successor or paid confirmation.
