...
9. **Economics — updated sensitivity and evidence-cost prototype complete; decision gate not passed** — the remediation-successor sample projects $10.01 per 100 all-Zoning turns after failed-work amortization. Mixed 100-turn provider p90 is $6.06 at 0% Zoning, $7.15 at 25%, $8.23 at 50%, and $10.41 at 100%. At 100% Zoning, modeled p90 contribution is negative $0.19 on web and negative $2.21 on iOS at 15%. The no-cost audit found 42,033 average assembled evidence characters versus 6,262 average reviewed exact-passage characters in the expanded parent. A three-budget real-reassembly prototype preserved all 87 exact selected sources and eight structured sources; the retained 24,000-character supplemental candidate averaged 34,821 assembled characters and kept 31 cross-references. It remains disabled pending full no-cost and semantic confirmation. The $20 price and 100-turn allowance remain unchanged assumptions.
   - Post-run [failure triage](./PERMITEXT_ZONING_SUCCESSOR_FAILURE_TRIAGE_2026-08-30.md) is complete without provider spend. The current successor now fails preflight at 29/30 because its deep-through-lot answer key names unselected ZR 24-382; a source-bound owner disposition is required before another successor or paid confirmation.
