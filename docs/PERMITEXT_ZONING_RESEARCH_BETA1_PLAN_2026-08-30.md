...
9. **Economics — updated sensitivity and full-cohort no-cost candidate check complete; decision gate not passed** — the historical first-remediation-successor sample projects $10.01 per 100 all-Zoning turns after failed-work amortization. Mixed 100-turn provider p90 is $6.06 at 0% Zoning, $7.15 at 25%, $8.23 at 50%, and $10.41 at 100%. At 100% Zoning, modeled p90 contribution is negative $0.19 on web and negative $2.21 on iOS at 15%. The corrected 27/30 advisory reduced average stored hash-bound passage text from 41,384 to 29,460 characters at the disabled 24,000 supplemental candidate while preserving every deterministic required section. Remediation successor 2 extends the disabled-candidate check to all 30 cases: 30/30 ready; 28,712 average and 38,896 maximum assembled characters; 6,352 average pinned and 22,360 average supplemental characters; 87 exact pinned sources, eight structured sources, 117 discovered sources, and 29 cross-references. All selected sources were preserved with zero provider tokens or cost. This is not semantic or cost acceptance. The candidate remains disabled, and the $20 price and 100-turn allowance remain unchanged assumptions. Evidence: [PERMITEXT_ZONING_SUCCESSOR_REMEDIATION_2_2026-08-30.md](./PERMITEXT_ZONING_SUCCESSOR_REMEDIATION_2_2026-08-30.md).
   - Post-run [failure triage](./PERMITEXT_ZONING_SUCCESSOR_FAILURE_TRIAGE_2026-08-30.md) remains historical evidence for the first remediation successor, whose stronger deterministic preflight is 27/30. The owner-approved corrections for the special-district, narrow-rear-yard, and deep-through-lot keys are frozen only in remediation successor 2, which passes 30/30 no-cost preflight. No new semantic run exists; the three execution paths, graded quality paths, reliability, and cost gates remain open.
