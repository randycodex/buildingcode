...
Recovery source committed as `6c43d0db4`. Signed development Release 1.0 (41.13) built, installed, launched and verified on the physical iPhone. Logs: `/tmp/permitext-perf08-recovery-release-build.log`, `/tmp/permitext-perf08-recovery-install.log`. This supersedes installed 41.12; no TestFlight/main/production update.
