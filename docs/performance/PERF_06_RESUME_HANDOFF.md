> Current task: PERF-12, transient Search persistence and obsolete-request cancellation. PERF-11 accepted locally for released web surfaces; final evidence in PERF_11_ACCEPTANCE_REMAINING.md. Local HEAD before acceptance-doc commit041ae9b94. Backend8797 now session76619; offline proxy8800 session98159, allow mode, browser perf11-offline has real installed library. Owner preview8796 remains running untouched. Phone unavailable while owner is out; no simulator.
