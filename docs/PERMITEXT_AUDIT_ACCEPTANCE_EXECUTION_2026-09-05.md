...
- Starting physical TestFlight candidate: 1.0 (59). The initial recovery-fixture changes affect tests only; the later native Project-facts PDF repair requires a new archive and internal TestFlight candidate.
